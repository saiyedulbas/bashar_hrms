...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item done"> <a href="<?php echo site_url('admin/training/');?>" data-link-data="<?php echo site_url('admin/training/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fas fa-portrait"></span> <?php echo $this->lang->line('left_training');?>
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/training_type/');?>" data-link-data="<?php echo site_url('admin/training_type/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fab fa-typo3"></span> <?php echo $this->lang->line('left_training_type');?>
