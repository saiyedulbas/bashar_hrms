...
Chart.defaults.global.legend.display = false;  
   ...
   var hrms_projects = new Chart(document.getElementById('hrms_projects').getContext("2d"), {
    type: 'bar',
    data: {
      datasets: [{
  ...
  var hrms_tasks = new Chart(document.getElementById('hrms_tasks').getContext("2d"), {
    type: 'line',
    data: {
      datasets: [{
        data: [24, 92, 77, 90, 91, 78, 28, 49, 23, 81, 15, 97, 94, 16, 99, 61,
  ...
  var hrms_department = new Chart(document.getElementById('hrms_department').getContext("2d"), {
    type: 'pie',
    data: {
  ...
  var hrms_designation = new Chart(document.getElementById('hrms_designation').getContext("2d"), {
    type: 'pie',
    data: {
  ...
  function resizeCharts() {
	hrms_payroll.resize();
	hrms_projects.resize();
    hrms_tasks.resize();
    hrms_department.resize();
    hrms_designation.resize();
  }
