...
<?php if(in_array('112',$role_resources_ids)) { ?>
 ...
 <?php if(in_array('113',$role_resources_ids)) { ?>
  ...
  <?php } ?>  
  <?php if(in_array('472',$role_resources_ids)) { ?>
  <div class="file-item">
    <div class="file-item-icon file-item-level-up fas fa-exchange-alt text-secondary"></div>
    <a href="<?php echo site_url('admin/accounting/turnover_report');?>" class="file-item-name">
      <strong><?php echo $this->lang->line('xin_acc_turnover_report');?></strong>
    </a>
  </div>
  <?php } ?>  
  <?php if(in_array('86',$role_resources_ids)) { ?>
  <div class="file-item">
    <div class="file-item-icon file-item-level-up fas fa-exchange-alt text-secondary"></div>
    <a href="<?php echo site_url('admin/accounting/ebl_report');?>" class="file-item-name">
      <strong><?php echo $this->lang->line('xin_accounting_ebl_report');?></strong>
    </a>
  </div>
  <?php } ?>  
</div>
