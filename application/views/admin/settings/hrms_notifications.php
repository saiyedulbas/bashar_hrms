  ...
  <div class="row no-gutters">
    ...
    <div class="messages-sidebox messages-scroll col">
      ...
      <div class="card-body pt-3">      
        ...
        <a href="javascript:void(0)" class="d-flex justify-content-between align-items-center text-muted py-2">
          ...
          <div class="badge badge-primary"><?php echo $this->Xin_model->hrms_notifications_count('leave',$session['user_id']);?></div>
        </a>
        <?php } ?>
        ...
        <a href="javascript:void(0)" class="d-flex justify-content-between align-items-center text-muted py-2">
          ...
          <div class="badge badge-primary"><?php echo $this->Xin_model->hrms_notifications_count('projects',$session['user_id']);?></div>
        </a>
        <?php } ?>
        ...
        <a href="javascript:void(0)" class="d-flex justify-content-between align-items-center text-muted py-2">
          ...
          <div class="badge badge-primary"><?php echo $this->Xin_model->hrms_notifications_count('tasks',$session['user_id']);?></div>
        </a>
        <?php } ?>
        ...
        <a href="javascript:void(0)" class="d-flex justify-content-between align-items-center text-muted py-2">
          ...
          <div class="badge badge-primary"><?php echo $this->Xin_model->hrms_notifications_count('announcement',$session['user_id']);?></div>
        </a>
        <?php } ?>
        ...
        <a href="javascript:void(0)" class="d-flex justify-content-between align-items-center text-muted py-2">
          ...
          <div class="badge badge-primary"><?php echo $this->Xin_model->hrms_notifications_count('tickets',$session['user_id']);?></div>
        </a>
        <?php } ?>
        <?php } ?>
        ...
        <a href="javascript:void(0)" class="d-flex justify-content-between align-items-center text-muted py-2">
          ...
          <div class="badge badge-primary"><?php echo $this->Xin_model->hrms_notifications_count('asset',$session['user_id']);?></div>
        </a>
        <?php } ?>
        ...
        <a href="javascript:void(0)" class="d-flex justify-content-between align-items-center text-muted py-2">
          ...
          <div class="badge badge-primary"><?php echo $this->Xin_model->hrms_notifications_count('awards',$session['user_id']);?></div>
        </a>
        <?php } ?>
        <!-- / Mail boxes -->
	...
	<?php
		...
		if(in_array('46',$role_resources_ids)) {
			$leave_count = $this->Xin_model->hrms_notifications_count('leave',$session['user_id']);
		}
		if(in_array('44',$role_resources_ids)) {
			$proj_count = $this->Xin_model->hrms_notifications_count('projects',$session['user_id']);
		}
		if(in_array('45',$role_resources_ids)) {
			$tsk_count = $this->Xin_model->hrms_notifications_count('tasks',$session['user_id']);
		}
		if(in_array('11',$role_resources_ids)) {
			$nst_count = $this->Xin_model->hrms_notifications_count('announcement',$session['user_id']);
		}
		if($system[0]->module_inquiry=='true'){
			if(in_array('43',$role_resources_ids)) {
				$tkt_count = $this->Xin_model->hrms_notifications_count('tickets',$session['user_id']);
			}
		}
		if(in_array('25',$role_resources_ids)) {
			$asset_count = $this->Xin_model->hrms_notifications_count('asset',$session['user_id']);
		}
		if(in_array('14',$role_resources_ids)) {
			$award_count = $this->Xin_model->hrms_notifications_count('awards',$session['user_id']);
		}
		// count);
    ...
    <div class="col">
     <?php if($fcount > 0) {?>
      ...
      <?php  if(in_array('46',$role_resources_ids)) { ?>
      <?php foreach($this->Xin_model->hrms_notifications('leave',$session['user_id']) as $leave_notify) {?>
		<?php
        ...
        <?php } ?>
      <?php  if(in_array('44',$role_resources_ids)) { ?>  
      <?php foreach($this->Xin_model->hrms_notifications('projects',$session['user_id']) as $nprj) {?>
      <?php $project_info = $result = $this->Project_model->read_project_information($nprj->module_id);?>
       ...
       <?php } ?>
       <?php  if(in_array('45',$role_resources_ids)) { ?>
       <?php foreach($this->Xin_model->hrms_notifications('tasks',$session['user_id']) as $ntsk) {?>
       ...
       <?php } ?>
       <?php  if(in_array('11',$role_resources_ids)) { ?>
       <?php foreach($this->Xin_model->hrms_notifications('announcement',$session['user_id']) as $n_annc) {?>
       ...
       <?php if($system[0]->module_inquiry=='true'){?>
        <?php  if(in_array('43',$role_resources_ids)) { ?>
       <?php foreach($this->Xin_model->hrms_notifications('tickets',$session['user_id']) as $n_ticket) {?>
	   ...
	   ?>
        ...
        <?php } ?>
        <?php  if(in_array('25',$role_resources_ids)) { ?>
        <?php foreach($this->Xin_model->hrms_notifications('asset',$session['user_id']) as $n_asset) {?>
	   ...
	   ?>
        ...
        <?php } ?>
        <?php  if(in_array('14',$role_resources_ids)) { ?>
        <?php foreach($this->Xin_model->hrms_notifications('awards',$session['user_id']) as $n_award) {?>
       <?php
