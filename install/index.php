...
<div class="container" style="margin-top:50px ">
  <div class="row">
    <div class="col-md-6 col-md-offset-5" style="margin-bottom:15px;"> <img src="../skin/img/hrms-white.png" /> </div>
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="https://tforcehrms.com/contact.php" target="_blank" style="text-decoration:underline;">Contact support</a>
                </footer>
            </div>
		</div>
