...
//$(document).ready(function(){
	...
	{ id: "", class: "role-checkbox custom-control-input custom-control-input", text: "<?php echo $this->lang->line('xin_hrms_custom_fields');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info');?>", value: "393",  items: [
	...
	{ id: "", class: "role-checkbox custom-control-input", text: "<?php echo $this->lang->line('xin_bonous_type_role');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "473"},
	...
	{ id: "", class: "role-checkbox custom-control-input", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "363",}
        ...
        //added by amirul for tax_chalan
        { id: "", class: "role-checkbox custom-control-input", text: "<?php echo $this->lang->line('xin_tax_chalan');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "100",items: [
	{ id: "", class: "role-checkbox custom-control-input", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "469",},
	{ id: "", class: "role-checkbox custom-control-input", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "470",},
	{ id: "", class: "role-checkbox custom-control-input", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "471",}
	]},
        //end
	...
	{ id: "", class: "role-checkbox custom-control-input", text: "<?php echo $this->lang->line('xin_acc_turnover_report');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "472",},
	]},
