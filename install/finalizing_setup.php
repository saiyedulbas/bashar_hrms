...
<title>TForce - The Intuitive HRMS</title>
...
<link rel="stylesheet" href="../skin/hrms_vendor/assets/vendor/toastr/toastr.min.css">
<link rel="stylesheet" href="../skin/hrms_vendor/assets/vendor/libs/ladda/ladda.css">
</head>
<body style="background:linear-gradient(90deg, #000000 0%, #d3e9ff 100%);">
<div class="container" style="margin-top:30px ">
  <div class="row">
    <div class="col-md-7 col-md-offset-5" style="margin-bottom:15px;"> <img src="../skin/img/hrms-white.png" /> </div>
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-primary">
        <div class="panel-heading"> <strong class="">TForce - The Intuitive HRMS</strong> </div>
        <div class="panel-body">
          ...
          <form class="form-horizontal" id="set_up" method="post" action="set_up.php">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input class="form-control" type="text" value="TForce" name="application_name">
        ...
        <div class="panel-footer"><?php echo date('Y');?> &copy TForce - The Intuitive HRMS</div>
      </div>
    </div>
  </div>
</div>
<script src="../skin/hrms_vendor/assets/vendor/js/jquery.min.js"></script>
<!-- jQuery UI 1.11.4 -->
<script src="../skin/hrms_vendor/assets/vendor/libs/jquery-ui/jquery-ui.min.js"></script>
<script src="../skin/hrms_vendor/assets/vendor/libs/spin/spin.js"></script>
<script src="../skin/hrms_vendor/assets/vendor/libs/ladda/ladda.js"></script>
<script src="../skin/hrms_vendor/assets/vendor/toastr/toastr.min.js"></script> 
