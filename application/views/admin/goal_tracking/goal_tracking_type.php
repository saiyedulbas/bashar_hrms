...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  ...
  <?php if($system[0]->performance_option == 'both') {?>
    ...
    <li class="nav-item done">
      <a href="<?php echo site_url('admin/performance_appraisal/');?>" data-link-data="<?php echo site_url('admin/performance_appraisal/');?>" class="mb-3 nav-link hrms-link">
    ...
    <li class="nav-item done">
      <a href="<?php echo site_url('admin/performance_indicator/');?>" data-link-data="<?php echo site_url('admin/performance_indicator/');?>" class="mb-3 nav-link hrms-link">
    ...
    <li class="nav-item done"> <a href="<?php echo site_url('admin/goal_tracking/');?>" data-link-data="<?php echo site_url('admin/goal_tracking/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fas fa-cube"></span> <?php echo $this->lang->line('xin_hr_goal_tracking');?>
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/goal_tracking/type/');?>" data-link-data="<?php echo site_url('admin/goal_tracking/type/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fab fa-typo3"></span> <?php echo $this->lang->line('xin_hr_goal_tracking_type_se');?>
