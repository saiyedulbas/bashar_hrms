                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="table table-striped m-md-b-0">
                    <tbody>
                      ...
                      <tr>
                        <th scope="row"><?php echo $this->lang->line('xin_alternet_employee');?></th>
                        <td class="text-right"><?php echo $employee_alternate;?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <th scope="row"><?php echo $this->lang->line('xin_hrms_total_days');?></th>
                        <td class="text-right">
                        <?php
						if($is_half_day == 1){
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="box-block card-dashboard">
                ...
                <?php
                if(count($leave_categories_ids)>1){
