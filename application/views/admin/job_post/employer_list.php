...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/job_post/employer/');?>" data-link-data="<?php echo site_url('admin/job_post/employer/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fas fa-user-ninja"></span> <?php echo $this->lang->line('xin_jobs_employer');?>
