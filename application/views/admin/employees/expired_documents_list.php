...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item done"> <a href="<?php echo site_url('admin/company/official_documents/');?>" data-link-data="<?php echo site_url('admin/company/official_documents/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fas fa-file-word"></span> <?php echo $this->lang->line('xin_hr_official_documents');?>
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/employees/expired_documents/');?>" data-link-data="<?php echo site_url('admin/employees/expired_documents/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fas fa-file-export"></span> <?php echo $this->lang->line('xin_e_details_exp_documents');?>
