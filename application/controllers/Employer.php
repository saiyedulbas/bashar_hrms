...
class Employer extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function sign_in() {
		...
		$data['subview'] = $this->load->view("frontend/hrms/sign_in", $data, TRUE);
	 ...
	 public function signup() {
		...
		$data['subview'] = $this->load->view("frontend/hrms/register", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
     }
	 public function logout() {
	  ...
	  public function forgot_password() {
		...
		$data['subview'] = $this->load->view("frontend/hrms/forgot_password", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
     }
	 public function change_password() {
		...
		$data['subview'] = $this->load->view("frontend/hrms/change_password", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
     }
	  ...
	  public function post_job() {
		...
		$data['subview'] = $this->load->view("frontend/hrms/post_job", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
     }
	 public function dashboard() {
		...
		$data['subview'] = $this->load->view("frontend/hrms/dashboard", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
     }
	...
	public function create_account() {
	 ...
	 public function edit_job() {
		...
		$data['subview'] = $this->load->view("frontend/hrms/edit_job", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
     }
	 ...
	 public function manage_jobs() {
		...
		$data['all_job_categories'] = $this->Recruitment_model->all_job_categories();
		$data['subview'] = $this->load->view("frontend/hrms/manage_jobs", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
     }
	 ...
	 public function manage_applications() {
		...
		$data['all_job_categories'] = $this->Recruitment_model->all_job_categories();
		$data['subview'] = $this->load->view("frontend/hrms/manage_applications", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
     }
	 ...
	 public function jobs_applications_list() {
		...
		$session = $this->session->userdata('c_user_id');
		if(!empty($session)){ 
			$this->load->view("frontend/hrms/manage_applications", $data);
		} else {
			redirect('');
		}
	 ...
	 public function employer_job_list() {
		...
		$session = $this->session->userdata('c_user_id');
		if(!empty($session)){ 
			$this->load->view("frontend/hrms/manage_jobs", $data);
		} else {
			redirect('');
		}
		// Datatables Variables
	...
	public function update_job() {
	 ...
	 public function account() {
		...
		$data['subview'] = $this->load->view("frontend/hrms/employer_account", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
     }
