...
class Xin_model extends CI_Model
{
    ...
    public function select_module_class($mClass, $mMethod)
    {
        ...
        if ($mClass=='dashboard') {
            ...
            $arr['open'] = '';
            return $arr;
        } elseif ($mClass=='department' && $mMethod=='sub_departments') {
            $arr['sub_departments_active'] = 'active';
            $arr['adm_open'] = 'open';
            return $arr;
        } elseif ($mClass=='department') {
            $arr['dep_active'] = 'active';
            $arr['adm_open'] = 'open';
            return $arr;
        } elseif ($mClass=='designation') {
            $arr['des_active'] = 'active';
            $arr['adm_open'] = 'open';
            return $arr;
        } elseif ($mClass=='company' && $mMethod=='official_documents') {
            $arr['official_documents_active'] = 'active';
            $arr['files_open'] = 'open';
            return $arr;
        } elseif ($mClass=='company') {
            $arr['com_active'] = 'active';
            $arr['adm_open'] = 'open';
            return $arr;
        }
        else if($mClass=='chat' && $mMethod=='newpusher') {
			$arr['pusher_active'] = 'active';
			$arr['pusher_open'] = 'open';
			return $arr;
		}
		else if($mClass=='chat' && $mMethod=='faq') {
			$arr['faq_active'] = 'active';
			$arr['pusher_open'] = 'open';
			return $arr;
		}
		elseif ($mClass=='location') {
            $arr['loc_active'] = 'active';
            $arr['adm_open'] = 'open';
            return $arr;
        } elseif ($mClass=='policy') {
            $arr['pol_active'] = 'active';
            $arr['adm_open'] = 'open';
            return $arr;
        } elseif ($mClass=='expense') {
            $arr['exp_active'] = 'active';
            $arr['adm_open'] = 'open';
            return $arr;
        } elseif ($mClass=='announcement') {
            $arr['ann_active'] = 'active';
            $arr['adm_open'] = 'open';
            return $arr;
        } elseif ($mClass=='employees' && $mMethod=='staff_dashboard') {
            $arr['staff_active'] = 'active';
            $arr['stff_open'] = 'open';
            return $arr;
        } elseif ($mClass=='employees' && $mMethod=='hr') {
            $arr['hremp_active'] = 'active';
            $arr['stff_open'] = 'open';
            return $arr;
        } elseif ($mClass=='employees' && $mMethod=='expired_documents') {
            $arr['expired_documents_active'] = 'active';
            $arr['files_open'] = 'open';
            return $arr;
        } elseif ($mClass=='employees' && $mMethod=='import') {
            $arr['importemp_active'] = 'active';
            $arr['stff_open'] = 'open';
            return $arr;
        } elseif ($mClass=='employees') {
            $arr['hremp_active'] = 'active';
            $arr['stff_open'] = 'open';
            return $arr;
            ...
            return $arr;
        }*/ elseif ($mClass=='awards') {
            $arr['awar_active'] = 'active';
            $arr['emp_open'] = 'open';
            return $arr;
        } elseif ($mClass=='transfers') {
            $arr['tra_active'] = 'active';
            $arr['emp_open'] = 'open';
            return $arr;
        } elseif ($mClass=='resignation') {
            $arr['res_active'] = 'active';
            $arr['emp_open'] = 'open';
            return $arr;
        } elseif ($mClass=='travel') {
            $arr['trav_active'] = 'active';
            $arr['emp_open'] = 'open';
            return $arr;
        } elseif ($mClass=='promotion') {
            $arr['pro_active'] = 'active';
            $arr['emp_open'] = 'open';
            return $arr;
        } elseif ($mClass=='complaints') {
            $arr['compl_active'] = 'active';
            $arr['emp_open'] = 'open';
            return $arr;
        } elseif ($mClass=='warning') {
            $arr['warn_active'] = 'active';
            $arr['emp_open'] = 'open';
            return $arr;
        } elseif ($mClass=='termination') {
            $arr['term_active'] = 'active';
            $arr['emp_open'] = 'open';
            return $arr;
        } elseif ($mClass=='employees_last_login') {
            $arr['emp_ll_active'] = 'active';
            $arr['emp_open'] = 'open';
            return $arr;
        } elseif ($mClass=='employee_exit') {
            $arr['emp_ex_active'] = 'active';
            $arr['emp_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='category' && $mClass=='assets') {
            $arr['asst_cat_active'] = 'active';
            $arr['asst_open'] = 'open';
            return $arr;
        } elseif ($mClass=='assets') {
            ...
            return $arr;
        } elseif ($mClass=='timesheet' && $mMethod=='attendance') {
            $arr['attnd_active'] = 'active';
            $arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mClass=='timesheet' && $mMethod=='timecalendar') {
            $arr['timecalendar_active'] = 'active';
            $arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='date_wise_attendance') {
            $arr['attnd_active'] = 'active';
            $arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='update_attendance') {
            $arr['upd_attnd_active'] = 'active';
            $arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mClass=='overtime_request') {
            $arr['overtime_request_act'] = 'active';
            $arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mClass=='timesheet' && $mMethod=='attendance_dashboard') {
            $arr['attendance_dashboard_active'] = 'active';
            $arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mClass=='timesheet' && $mMethod=='import') {
            $arr['import_attnd_active'] = 'active';
            $arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='office_shift' && $mClass=='timesheet') {
            $arr['shift_active'] = 'active';
            $arr['stff_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='holidays' && $mClass=='timesheet') {
            $arr['hol_active'] = 'active';
            //$arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='leave' && $mClass=='timesheet') {
            $arr['leave_active'] = 'active';
            //$arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='leave_details' && $mClass=='timesheet') {
            $arr['leave_active'] = 'active';
            //$arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mClass=='timesheet' && $mMethod=='index') {
            $arr['timesheet_active'] = 'active';
            $arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mClass=='calendar' && $mMethod=='attendance') {
            $arr['attnd_cal_active'] = 'active';
            $arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='hourly_wages') {
            $arr['pay_hourly_active'] = 'active';
            $arr['payrl_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='templates') {
            $arr['pay_temp_active'] = 'active';
            $arr['payrl_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='manage_salary') {
            $arr['pay_mang_active'] = 'active';
            $arr['payrl_open'] = 'open';
            return $arr;
        } elseif ($mClass=='payroll' && $mMethod=='payslip') {
            $arr['pay_generate_active'] = 'active';
            $arr['payrl_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='generate_payslip') {
            $arr['pay_generate_active'] = 'active';
            $arr['payrl_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='payment_history') {
            $arr['pay_generate_active'] = 'active';
            //$arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='currency_converter') {
            $arr['curren_conv_active'] = 'active';
            $arr['payrl_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='advance_salary') {
            $arr['pay_advn_active'] = 'active';
            $arr['payrl_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='advance_salary_report') {
            $arr['pay_advn_rpt_active'] = 'active';
            $arr['payrl_open'] = 'open';
            return $arr;
        } elseif ($mClass=='performance_indicator') {
            $arr['performance_active'] = 'active';
            $arr['performance_open'] = 'open';
            return $arr;
        } elseif ($mClass=='performance_report') {
            $arr['performance_active'] = 'active';
            $arr['performance_open'] = 'open';
            return $arr;
        } elseif ($mClass=='performance_maingoals') {
            $arr['performance_active'] = 'active';
            $arr['performance_open'] = 'open';
            return $arr;
        } elseif ($mClass=='performance_appraisal') {
            $arr['performance_active'] = 'active';
            $arr['performance_open'] = 'open';
            return $arr;
        } elseif ($mClass=='organization' && $mMethod=='chart') {
            $arr['org_chart_active'] = 'active';
            $arr['adm_open'] = 'open';
            return $arr;
        } elseif ($mClass=='calendar' && $mMethod=='hr') {
            $arr['calendar_hr_active'] = 'active';
            return $arr;
        } elseif ($mClass=='tickets') {
            $arr['ticket_active'] = 'active';
            return $arr;
        } elseif ($mMethod=='calendar' && $mClass=='leave') {
            $arr['leave_cal_active'] = 'active';
            $arr['leave_open'] = 'open';
            return $arr;
        } elseif ($mClass=='project' && $mMethod=='projects_dashboard') {
            $arr['projects_dashboard_active'] = 'active';
            $arr['project_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='projects_scrum_board' && $mClass=='project') {
            $arr['projects_scrum_board_active'] = 'active';
            $arr['project_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='tasks_scrum_board' && $mClass=='project') {
            $arr['tasks_scrum_board_active'] = 'active';
            $arr['task_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='tasks_calendar' && $mClass=='project') {
            $arr['tasks_calendar_active'] = 'active';
            $arr['task_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='projects_calendar' && $mClass=='project') {
            $arr['projects_calendar_active'] = 'active';
            $arr['project_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='timelogs' && $mClass=='project') {
            $arr['project_timelogs_active'] = 'active';
            $arr['project_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='timelogs' && $mClass=='quoted_projects') {
            $arr['timelogs_quotes_active'] = 'active';
            $arr['hr_quote_manager_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='quote_calendar' && $mClass=='quoted_projects') {
            $arr['quote_calendar_active'] = 'active';
            $arr['hr_quote_manager_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='task_categories' && $mClass=='project') {
            $arr['task_cat_active'] = 'active';
            $arr['project_open'] = 'open';
            return $arr;
        } elseif ($mClass=='project') {
            $arr['project_active'] = 'active';
            $arr['project_open'] = 'open';
            return $arr;
        } elseif ($mClass=='projects') {
            $arr['projects_active'] = 'active';
            $arr['projects_active'] = 'open';
            return $arr;
        } elseif ($mMethod=='tasks' && $mClass=='timesheet') {
            $arr['task_active'] = 'active';
            $arr['task_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='task_details') {
            $arr['task_active'] = 'active';
            $arr['task_open'] = 'open';
            return $arr;
        } elseif ($mClass=='clients') {
            $arr['clients_active'] = 'active';
            $arr['project_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='import' && $mClass=='leads') {
            ...
            $arr['hr_quote_manager_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='create' && $mClass=='invoices') {
            $arr['hr_create_inv_active'] = 'active';
            $arr['invoices_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='create' && $mClass=='quotes') {
            $arr['all_quotes_active'] = 'active';
            $arr['hr_quote_manager_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='taxes' && $mClass=='invoices') {
            $arr['taxes_inv_active'] = 'active';
            $arr['invoices_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='payments_history' && $mClass=='invoices') {
            $arr['payments_history_inv_active'] = 'active';
            $arr['invoices_open'] = 'open';
            return $arr;
        } elseif ($mClass=='quoted_projects') {
            $arr['quoted_projects_active'] = 'active';
            $arr['hr_quote_manager_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='invoice_calendar' && $mClass=='invoices') {
            $arr['invoice_calendar_active'] = 'active';
            $arr['invoices_open'] = 'open';
            return $arr;
        } elseif ($mClass=='invoices') {
            $arr['invoices_inv_active'] = 'active';
            $arr['invoices_open'] = 'open';
            return $arr;
        } elseif ($mClass=='quotes') {
            $arr['all_quotes_active'] = 'active';
            $arr['hr_quote_manager_open'] = 'open';
            return $arr;
        } elseif ($mClass=='files') {
            ...
            $arr['files_open'] = 'open';
            return $arr;
        } elseif ($mClass=='import') {
            $arr['import_active'] = 'active';
            return $arr;
        } elseif ($mClass=='job_post' && $mMethod=='pages') {
            $arr['jb_pages_active'] = 'active';
            $arr['recruit_open'] = 'open';
            return $arr;
        } elseif ($mClass=='job_post' && $mMethod=='employer') {
            $arr['jb_employer_active'] = 'active';
            $arr['recruit_open'] = 'open';
            return $arr;
        } elseif ($mClass=='job_post') {
            $arr['jb_post_active'] = 'active';
            $arr['recruit_open'] = 'open';
            return $arr;
        } elseif ($mClass=='job_candidates') {
            $arr['job_candidates_active'] = 'active';
            $arr['recruit_open'] = 'open';
            return $arr;
        } elseif ($mClass=='job_interviews') {
            $arr['jb_post_active'] = 'active';
            $arr['recruit_open'] = 'open';
            return $arr;
        } elseif ($mClass=='training') {
            $arr['training_active'] = 'active';
            $arr['training_open'] = 'open';
            return $arr;
        } elseif ($mClass=='training_type') {
            $arr['tr_type_active'] = 'active';
            $arr['training_open'] = 'open';
            return $arr;
        } elseif ($mClass=='trainers') {
            ...
            $arr['stff_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='constants' && $mClass=='settings') {
            $arr['constants_active'] = 'active';
            $arr['system_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='database_backup' && $mClass=='settings') {
            $arr['db_active'] = 'active';
            $arr['system_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='email_template' && $mClass=='settings') {
            $arr['email_template_active'] = 'active';
            $arr['system_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='modules' && $mClass=='settings') {
            ...
            $arr['system_open'] = 'open';
            return $arr;
        } elseif ($mClass=='settings') {
            $arr['settings_active'] = 'active';
            $arr['system_open'] = 'open';
            return $arr;
        } elseif ($mMethod=='changelog') {
            $arr['changelog_active'] = 'active';
            return $arr;
        } elseif ($mClass=='languages') {
            $arr['languages_active'] = 'active';
            $arr['system_open'] = 'open';
            return $arr;
        } elseif ($mClass=='events' && $mMethod=='calendar') {
            $arr['hr_ecalendar_active'] = 'active';
            $arr['hr_events_open'] = 'open';
            return $arr;
        } elseif ($mClass=='meetings') {
            $arr['hr_meetings_active'] = 'active';
            $arr['hr_events_open'] = 'open';
            return $arr;
        } elseif ($mClass=='events') {
            $arr['hr_events_active'] = 'active';
            $arr['hr_events_open'] = 'open';
            return $arr;
        } elseif ($mClass=='goal_tracking' && $mMethod=='calendar') {
            $arr['performance_active'] = 'active';
            $arr['performance_open'] = 'open';
            return $arr;
        } elseif ($mClass=='goal_tracking' && $mMethod=='type') {
            $arr['performance_active'] = 'active';
            $arr['performance_open'] = 'open';
            return $arr;
        } elseif ($mClass=='goal_tracking') {
            $arr['performance_active'] = 'active';
            $arr['performance_open'] = 'open';
            return $arr;
        } elseif ($mClass=='reports'  && $mMethod=='employee_leave') {
            $arr['leave_active'] = 'active';
            //$arr['attnd_open'] = 'open';
            return $arr;
        } elseif ($mClass=='reports'  && $mMethod=='payslip') {
            $arr['reports_active'] = 'active';
            $arr['reports_open'] = 'open';
            return $arr;
        } elseif ($mClass=='reports'  && $mMethod=='employee_attendance') {
            $arr['reports_active'] = 'active';
            $arr['reports_open'] = 'open';
            return $arr;
        } elseif ($mClass=='reports'  && $mMethod=='employee_training') {
            $arr['reports_active'] = 'active';
            $arr['reports_open'] = 'open';
            return $arr;
        } elseif ($mClass=='reports'  && $mMethod=='projects') {
            $arr['reports_active'] = 'active';
            $arr['reports_open'] = 'open';
            return $arr;
        } elseif ($mClass=='reports'  && $mMethod=='tasks') {
            $arr['reports_active'] = 'active';
            $arr['reports_open'] = 'open';
            return $arr;
        } elseif ($mClass=='reports'  && $mMethod=='roles') {
            $arr['reports_active'] = 'active';
            $arr['reports_open'] = 'open';
            return $arr;
        } elseif ($mClass=='reports'  && $mMethod=='employees') {
            $arr['reports_active'] = 'active';
            $arr['reports_open'] = 'open';
            return $arr;
        } elseif ($mClass=='reports') {
            $arr['reports_active'] = 'active';
            return $arr;
        } elseif ($mClass=='user' && $mMethod=='awards') {
            $arr['hr_awards_active'] = 'active';
            $arr['mylink_open'] = 'open';
            return $arr;
        } elseif ($mClass=='user' && $mMethod=='transfer') {
            $arr['hr_transfer_active'] = 'active';
            $arr['mylink_open'] = 'open';
            return $arr;
        } elseif ($mClass=='user' && $mMethod=='promotion') {
            $arr['hr_promotion_active'] = 'active';
            $arr['mylink_open'] = 'open';
            return $arr;
        } elseif ($mClass=='user' && $mMethod=='complaints') {
            $arr['hr_complaints_active'] = 'active';
            $arr['mylink_open'] = 'open';
            return $arr;
        } elseif ($mClass=='user' && $mMethod=='warning') {
            $arr['hr_warning_active'] = 'active';
            $arr['mylink_open'] = 'open';
            return $arr;
        } elseif ($mClass=='user' && $mMethod=='travel') {
            $arr['hr_travel_active'] = 'active';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='accounting_dashboard') {
            $arr['dashboard_accounting_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='bank_cash') {
            $arr['bank_cash_act'] = 'active';
            $arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='account_balances') {
            $arr['dashboard_accounting_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='transfer') {
            $arr['transfer_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='deposit') {
            $arr['deposit_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='expense') {
            $arr['expense_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='transactions') {
            $arr['transactions_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='tax_chalan') {
            $arr['tax_chalan_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='bankwise_transactions') {
            $arr['dashboard_accounting_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='accounts_ledger') {
            $arr['dashboard_accounting_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='payees') {
            $arr['hr_payees_active'] = 'active';
            //$arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='payers') {
            $arr['hr_payers_active'] = 'active';
            //$arr['hr_acc_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='account_statement') {
            $arr['reports_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            $arr['hr_acc_report_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='expense_report') {
            $arr['reports_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            $arr['hr_acc_report_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='income_report') {
            $arr['reports_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            $arr['hr_acc_report_open'] = 'open';
            return $arr;
        } elseif ($mClass=='accounting' && $mMethod=='transfer_report') {
            $arr['reports_active'] = 'active';
            $arr['hr_acc_open'] = 'open';
            $arr['hr_acc_report_open'] = 'open';
            return $arr;
        } elseif ($mClass=='profile' && isset($_GET['change_password'])=='true') {
            $arr['hr_password_active'] = 'active';
            return $arr;
        } elseif ($mClass=='invoices' && $mClass=='payments_history') {
    ...
    public function read_employee_by_id($id)
    {
    ...
    public function read_branch_setting_info($id)
    {
        $sql = 'SELECT * FROM xin_companies WHERE company_id = ?';
        $binds = array($id);
        $query = $this->db->query($sql, $binds);
    ...
    public function convertNumberToWord(float $amount)
    {
   ...
   " . $change_words[$amount_after_decimal % 10]) . ' Paise' : '';
    ...
    public function set_date_format_js()
    {
        ...
        if ($system_setting[0]->date_format_xi=='d-m-Y') {
            $d_format = 'dd-mm-yy';
        } elseif ($system_setting[0]->date_format_xi=='m-d-Y') {
            $d_format = 'mm-dd-yy';
        } elseif ($system_setting[0]->date_format_xi=='d-M-Y') {
            $d_format = 'dd-M-yy';
        } elseif ($system_setting[0]->date_format_xi=='M-d-Y') {
            $d_format = 'M-dd-yy';
            ;
    ...
    public function all_employees_active()
    {
    ...
    public function all_employees_bonous($company_id=null, $department_id=null, $employee_id=null)
    {
        $this->db->select('*');
    ...
    //get employee earn leavefor selected year
    public function getemployee_current_year_earn_leave($emp_id, $year)
    {
        $sql = 'SELECT * FROM xin_employee_earn_leave WHERE employee_id = ? and year=? order by id desc';
        $binds = array($emp_id,$year);
        $query = $this->db->query($sql, $binds);
        return $query->row();
    }
    public function getemployee_last_earn_leave($emp_id)
    {
        $sql = 'SELECT * FROM xin_employee_earn_leave WHERE employee_id = ? order by id desc';
        $binds = array($emp_id);
        $query = $this->db->query($sql, $binds);
        return $query->row();
    }
    //insert earn leave data
    public function insert_earn_leave($data)
    {
        $this->db->insert('xin_employee_earn_leave', $data);
    ...
    public function set_date_format($date)
    {
        ...
        if ($system_setting[0]->date_format_xi=='d-m-Y') {
            ...
            $d_format = date("M-d-Y", strtotime($date));
        } elseif ($system_setting[0]->date_format_xi=='F-j-Y') {
            $d_format = date("F-j-Y", strtotime($date));
        } elseif ($system_setting[0]->date_format_xi=='j-F-Y') {
    ...
    public function get_selected_language_name($site_lang)
    {
        ...
        if ($site_lang=='english') {
            $name = 'English';
        } elseif ($site_lang=='chineese') {
            $name = 'Chineese';
        } elseif ($site_lang=='danish') {
            $name = 'Danish';
        } elseif ($site_lang=='french') {
            $name = 'French';
        } elseif ($site_lang=='german') {
            $name = 'German';
        } elseif ($site_lang=='greek') {
            $name = 'Greek';
        } elseif ($site_lang=='indonesian') {
            $name = 'Indonesian';
        } elseif ($site_lang=='italian') {
            $name = 'Italian';
        } elseif ($site_lang=='japanese') {
            $name = 'Japanese';
        } elseif ($site_lang=='polish') {
            $name = 'Polish';
        } elseif ($site_lang=='portuguese') {
            $name = 'Portuguese';
        } elseif ($site_lang=='romanian') {
            $name = 'Romanian';
        } elseif ($site_lang=='russian') {
            $name = 'Russian';
        } elseif ($site_lang=='spanish') {
            $name = 'Spanish';
        } elseif ($site_lang=='turkish') {
            $name = 'Turkish';
        } elseif ($site_lang=='vietnamese') {
            $name = 'Vietnamese';
        } else {
            $name = 'English';
        }
...
ORDER BY `next_birthday`");
    ...
    public function get_department_employees_announcement($to_id, $location_id)
    {
        if ($to_id!=0) {
            $sql = 'SELECT * FROM xin_employees WHERE department_id = ? and user_role_id!=1';
            $binds = array($to_id);
...
ORDER BY `expiry_date`");
    ...
    // get notifications
    public function hrms_notifications($module_name, $employee_id)
    {
        $sql = 'SELECT * FROM xin_hrms_notificaions WHERE module_name = ? and employee_id = ? and is_notify = ?';
        $binds = array($module_name,$employee_id,1);
        $query = $this->db->query($sql, $binds);
        return $query->result();
    }
    // get notifications>count
    public function hrms_notifications_count($module_name, $employee_id)
    {
        $sql = 'SELECT * FROM xin_hrms_notificaions WHERE module_name = ? and employee_id = ? and is_notify = ?';
        $binds = array($module_name,$employee_id,1);
        $query = $this->db->query($sql, $binds);
    ...
    {
        $this->db->insert('xin_hrms_notificaions', $data);
        if ($this->db->affected_rows() > 0) {
            return true;
        } else {
            return false;
    ...
    public function update_notification_record($data, $id, $employee_id, $module_name)
    {
        ...
        if ($this->db->update('xin_hrms_notificaions', $data)) {
            return true;
        } else {
            return false;
        }
