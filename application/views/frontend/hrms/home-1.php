...
<!-- Slider
================================================== -->
<div id="banner" style="background-image: url(<?php echo base_url();?>skin/vendor/jobs/hrms/images/banner-home-01.jpg)" class="parallax background" data-img-width="2000" data-img-height="1330" data-diff="400">
	<div class="container">
	...
	<div class="sixteen columns">
		...
		<div class="showbiz our-clients" data-left="#showbiz_left_2" data-right="#showbiz_right_2">
			<div class="overflowholder">
				...
				<ul>
					<!-- Item -->
					<li><img src="<?php echo base_url();?>skin/vendor/jobs/hrms/images/logo-01.png" alt="" /></li>
					<li><img src="<?php echo base_url();?>skin/vendor/jobs/hrms/images/logo-02.png" alt="" /></li>
					<li><img src="<?php echo base_url();?>skin/vendor/jobs/hrms/images/logo-03.png" alt="" /></li>
					<li><img src="<?php echo base_url();?>skin/vendor/jobs/hrms/images/logo-04.png" alt="" /></li>
					<li><img src="<?php echo base_url();?>skin/vendor/jobs/hrms/images/logo-05.png" alt="" /></li>
					<li><img src="<?php echo base_url();?>skin/vendor/jobs/hrms/images/logo-06.png" alt="" /></li>
					<li><img src="<?php echo base_url();?>skin/vendor/jobs/hrms/images/logo-07.png" alt="" /></li>
				</ul>
				<div class="clearfix"></div>
