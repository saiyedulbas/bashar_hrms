...
<link rel="stylesheet" href="<?php echo base_url();?>skin/hrms_assets/vendor/orgchart/css/font-awesome.min.css">
<link rel="stylesheet" href="<?php echo base_url();?>skin/hrms_assets/vendor/orgchart/css/jquery.orgchart.css">
<link rel="stylesheet" href="<?php echo base_url();?>skin/hrms_assets/vendor/orgchart/css/style.css">
<style type="text/css">
.orgchart {
	background: #fff;
}
...
<script type="text/javascript" src="<?php echo base_url();?>skin/hrms_assets/vendor/orgchart/js/html2canvas.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>skin/hrms_assets/vendor/orgchart/js/jquery.orgchart.js"></script>
