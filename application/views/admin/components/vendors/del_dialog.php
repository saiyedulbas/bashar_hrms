  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php $attributes = array('name' => 'delete_record', 'id' => 'delete_record', 'autocomplete' => 'off', 'role'=>'form');?>
		...
		<?php echo form_button(array('name' => 'hrms_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fa far fa-check-square"></i> '.$this->lang->line('xin_confirm_del'))); ?> <?php echo form_close(); ?> </div>
    </div>
  </div>
</div>
<div class="modal fadeInLeft email-modal animated " role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"> <?php echo form_button(array('aria-label' => 'Close', 'data-dismiss' => 'modal', 'type' => 'button', 'class' => 'close', 'content' => '<span aria-hidden="true">×</span>')); ?> <strong class="modal-title"><?php echo $this->lang->line('xin_email_confirm');?></strong> </div>
      
      <?php $attributes = array('name' => 'email_record', 'id' => 'email_record', 'autocomplete' => 'off', 'role'=>'form');?>
        <?php $hidden = array('_method' => 'POST', '_token' => '111');?>
        <?php echo form_open('', $attributes, $hidden);?> 
      	<div class="modal-footer">
...
<div class="modal modal-slide view-modal-data fade " id="modals-slide" aria-hidden="true">
  <div class="modal-dialog">
