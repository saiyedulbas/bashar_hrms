...
<div class="modal-body">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label for="email" class="control-label"><?php echo $this->lang->line('xin_e_details_notifyemail');?><i class="hrms-asterisk">*</i></label>
...
<div class="form-body">
  <div class="row">
	<div class="col-md-6">
	  <div class="form-group">
		<label for="license_name"><?php echo $this->lang->line('xin_hr_official_license_name');?><i class="hrms-asterisk">*</i></label>
	  ...
	  <div class="form-group">
        ...
        <?php if($user_info[0]->user_role_id==1){ ?>
		  <div class="col-md-6">
			<label for="company_id"><?php echo $this->lang->line('left_company');?><i class="hrms-asterisk">*</i></label>
          ...
          <?php } ?>
		  <div class="col-md-6">
			<label for="expiry_date"><?php echo $this->lang->line('xin_expiry_date');?><i class="hrms-asterisk">*</i></label>
		...
		<div class="row">
		  <div class="col-md-6">
			<div class="form-group">
			  <fieldset class="form-group">
				<label for="scan_file"><?php echo $this->lang->line('xin_hr_official_license_scan');?><i class="hrms-asterisk">*</i></label>
	...
	<div class="col-md-6">
	  <div class="form-group">
		<label for="license_number"><?php echo $this->lang->line('xin_hr_official_license_number');?><i class="hrms-asterisk">*</i></label>
...
<?php echo form_open_multipart('admin/assets/update_asset/'.$assets_id, $attributes, $hidden);?>
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="first_name"><?php echo $this->lang->line('xin_acc_category');?><i class="hrms-asterisk">*</i></label>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="asset_name" class="control-label"><?php echo $this->lang->line('xin_asset_name');?><i class="hrms-asterisk">*</i></label>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group" id="employee_ajx">
              <label for="first_name"><?php echo $this->lang->line('xin_assets_assign_to');?><i class="hrms-asterisk">*</i></label>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <fieldset class="form-group">
                <label for="asset_image"><?php echo $this->lang->line('xin_asset_image');?><i class="hrms-asterisk">*</i></label>
    ...
    <?php $module_attributes = $this->Custom_fields_model->assets_hrms_module_attributes();?>
    <div class="row">
