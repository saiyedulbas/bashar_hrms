...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/job_candidates/');?>" data-link-data="<?php echo site_url('admin/job_candidates/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fas fa-user-friends"></span> <?php echo $this->lang->line('left_job_candidates');?>
    ...
    <li class="nav-item done"> <a href="<?php echo site_url('admin/job_post/pages/');?>" data-link-data="<?php echo site_url('admin/job_post/pages/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon ion ion-ios-paper"></span> <?php echo $this->lang->line('xin_jobs_cms_pages');?>
