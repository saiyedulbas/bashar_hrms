...
if ( ! function_exists('hrms_office_shift'))
{
	function hrms_office_shift() {
		$CI =&	get_instance();
...
if ( ! function_exists('hrms_payroll'))
{
	function hrms_payroll($salary_month) {
			$CI =&	get_instance();
			$CI->db->from('xin_salary_payslips');
...
if ( ! function_exists('ihrms_user_payroll'))
{
	function ihrms_user_payroll($salary_month,$employee_id) {
			$CI =&	get_instance();
			$CI->db->from('xin_salary_payslips');
			$CI->db->where('salary_month',$salary_month);
...
if ( ! function_exists('hrms_payroll_this_month'))
{
	function hrms_payroll_this_month() {
			$CI =&	get_instance();
			$CI->db->from('xin_salary_payslips');
...
if ( ! function_exists('hrms_user_payroll_this_month'))
{
	function hrms_user_payroll_this_month($employee_id) {
			$CI =&	get_instance();
			$CI->db->from('xin_salary_payslips');
			$CI->db->where('salary_month',date('Y-m'));
			$CI->db->where('employee_id',$employee_id);
...
if ( ! function_exists('hrms_payroll_last_6_month'))
{
	function hrms_payroll_last_6_month() {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 5; $i++)  {
...
if ( ! function_exists('hrms_user_payroll_last_6_month'))
{
	function hrms_user_payroll_last_6_month($employee_id) {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 5; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrms_payroll_last_1year'))
{
	function hrms_payroll_last_1year() {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 11; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrms_user_payroll_last_1year'))
{
	function hrms_user_payroll_last_1year($employee_id) {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 11; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrms_payroll_last_2years'))
{
	function hrms_payroll_last_2years() {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 23; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrms_user_payroll_last_2years'))
{
	function hrms_user_payroll_last_2years($employee_id) {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 23; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrms_payroll_last_3years'))
{
	function hrms_payroll_last_3years() {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 35; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('hrms_user_payroll_last_3years'))
{
	function hrms_user_payroll_last_3years($employee_id) {
		$CI =&	get_instance();
		$fn = 0;
		for ($i = 0; $i <= 35; $i++)  {
			$months = date("Y-m", strtotime( date( 'Y-m-01' )." -$i months"));
...
if ( ! function_exists('last_client_invoice_info'))
{
	function last_client_invoice_info() {
		$CI =&	get_instance();
		$sql = 'SELECT * FROM xin_hrms_invoices order by invoice_id desc limit 1';
		$query = $CI->db->query($sql);
		if ($query->num_rows() > 0) {
			$inv = $query->result();
			if(!is_null($inv)) {
