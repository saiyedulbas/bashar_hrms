      ...
      <div class="col-md-6">
        ...
        <div class="col-md-4">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_company_asset_value');?>" name="asset_value" type="text" value="<?php echo $asset_value; ?>">
            </div>
        </div>
          <div class="col-md-6">
            <div class="form-group">
    ...
    <table class="footable-details table table-striped table-hover toggle-circle">
      <tbody>
        ...
        <tr>
          ...
          <td style="display: table-cell;"><?php echo $asset_value;?></td>
        </tr>
        <tr>
