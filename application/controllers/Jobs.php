...
class Jobs extends MY_Controller {
	...
	public function index() {
       ...
       // $data["results"] = $this->Xin_recruitment_model->fetch_all_jobs($config["per_page"], $page);
		...
		$data['subview'] = $this->load->view("frontend/hrms/jobs_list", $data, TRUE);
	 ...
	 public function search() {
		...
		$data['subview'] = $this->load->view("frontend/hrms/jobs_search", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
     }	 
	 ...
	 public function categories() {
		...
		$data['all_job_categories'] = $this->Recruitment_model->all_job_categories();
		$data['subview'] = $this->load->view("frontend/hrms/job_categories", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
     }
	 ...
	 public function detail()
	{
		...
		$data['subview'] = $this->load->view("frontend/hrms/jobs_detail", $data, TRUE);
		$this->load->view('frontend/hrms/job_layout/job_layout', $data); //page load
	}
	...
	public function apply_job() {
		...
		if($this->input->post('full_name')==='') {
			...
			$Return['error'] = $this->lang->line('xin_employee_error_phone');
