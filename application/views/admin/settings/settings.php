...
<div id="smarsdstwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/settings/');?>" data-link-data="<?php echo site_url('admin/settings/');?>" class="mb-3 nav-link hrms-link"><span class="sw-icon fas fa-cog"></span> <?php echo $this->lang->line('xin_system');?>
      <div class="text-muted small"><?php echo $this->lang->line('header_configuration');?></div>
      </a> </li>
    <?php } ?>
    <?php if(in_array('61',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/settings/constants/');?>" data-link-data="<?php echo site_url('admin/settings/constants/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fas fa-adjust"></span> <?php echo $this->lang->line('left_constants');?>
      <div class="text-muted small"><?php echo $this->lang->line('xin_set_up_all_types');?></div>
      </a> </li>
    <?php } ?>
    <?php if(in_array('93',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/settings/modules/');?>" data-link-data="<?php echo site_url('admin/settings/modules/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fas fa-life-ring"></span> <?php echo $this->lang->line('xin_setup_modules');?>
      <div class="text-muted small"><?php echo $this->lang->line('xin_enable_disable_modules');?></div>
      </a> </li>
    <?php } ?>
    <?php if(in_array('62',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/settings/database_backup/');?>" data-link-data="<?php echo site_url('admin/settings/database_backup/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fa fa-database"></span> <?php echo $this->lang->line('header_db_log');?>
      <div class="text-muted small"><?php echo $this->lang->line('xin_database_backup_restore');?></div>
      </a> </li>
    <?php } ?>
    <?php if(in_array('63',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/settings/email_template/');?>" data-link-data="<?php echo site_url('admin/settings/email_template/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fas fa-envelope"></span> <?php echo $this->lang->line('left_email_templates');?>
...
<?php
	...
	$active118 = '';$active437 = '';$active438 = '';$active439 = '';$active440 = '';$active441 = '';$active466 = '';$active467='';
	$actshow297 = '';$actshow431 = '';$actshow432 = '';$actshow433 = '';$actshow434 = '';$actshow435 = '';$actshow436 = '';
	$actshow118 = '';$actshow437 = '';$actshow438 = '';$actshow439 = '';$actshow440 = '';$actshow441 = '';$actshow466 = '';$actshow467='';
	$active = '';
	$actshow = '';
  ...
  <div class="row no-gutters row-bordered row-border-light">
    <div class="col-md-3 pt-0">
      <div class="list-group list-group-flush account-settings-links">
        ...
        <?php } ?>
         <?php if(in_array('431',$role_resources_ids)) { ?>
        <a class="list-group-item list-group-item-action <?php echo $active467;?>" data-toggle="list" href="#earn-leave"><i class="ion ion-logo-buffer text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_earn_leave');?></a>
        <?php } ?>
    ...
    <div class="col-md-9">
      <div class="tab-content">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <label class="form-label"><?php echo $this->lang->line('xin_hrms_default_language');?></label>
                      <select class="form-control" name="default_language" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_hrms_default_language');?>">
        ...
        <div class="tab-pane fade <?php echo $actshow467;?>" id="earn-leave">
          <div class="card-body">
            <div class="card-block">
              <?php $attributes = array('name' => 'earn_leave', 'id' => 'earn_leave', 'autocomplete' => 'off', 'class' => 'm-b-1 add');?>
                <?php $hidden = array('u_earn_leave' => 'UPDATE');?>
                <?php echo form_open('admin/settings/earn_leave/', $attributes, $hidden);?>
                <div class="form-group">
                  <label class="form-label"><?php echo $this->lang->line('xin_select_year');?></label>
                <input class="form-control earn_year" placeholder="<?php echo $this->lang->line('xin_select_month');?>" id="year" name="year" type="text" value="<?php echo date('Y');?>">
                </div>
                <div class="form-actions box-footer">
                  <button type="submit" class="btn btn-primary"> <i class="far fa-check-square"></i> <?php echo $this->lang->line('xin_save');?> </button>
                </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="email_type" id="email_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_mail_type_config');?>">
                        ...
                        <option value="smtp" <?php if($email_type == 'smtp'):?> selected="selected"<?php endif;?>>SMTP Mail()</option>
                      </select>
                    </div>
                  </div>
                </div>
          ...
          <div class="card-body pb-2">
            <div class="card-block">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="form-label"> <?php echo $this->lang->line('xin_hrms_dashboard_options');?></label>
                    <select class="form-control" name="dashboard_option" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
                      ...
                      <option value="dashboard_light_2" <?php if($dashboard_option=='dashboard_light_2'){?> selected <?php }?>> <?php echo $this->lang->line('xin_hrms_dashboard_2light');?></option>
                      <option value="dashboard_dark_2" <?php if($dashboard_option=='dashboard_dark_2'){?> selected <?php }?>> <?php echo $this->lang->line('xin_hrms_dashboard_2dark');?></option>
                    ...
                    <br />
                    <small class="text-muted"><i class="fas fa-hand-point-up"></i> <?php echo $this->lang->line('xin_hrms_dashboard_options_details');?></small> </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label class="form-label" data-trigger="hover"> <?php echo $this->lang->line('xin_hrms_show_calendar_on_dashboard');?> </label>
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <label class="switcher switcher-success">
              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <select multiple="multiple" name="hr_top_menu[]" size="20" id="duallistbox-example">
                    ...
                    <option value="custom_fields" <?php if(in_array('custom_fields',$hr_top_menu)):?> selected="selected"<?php endif;?>><?php echo $this->lang->line('xin_hrms_custom_fields');?></option>
                    <?php } ?>
