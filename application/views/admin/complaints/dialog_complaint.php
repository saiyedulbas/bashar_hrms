  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <label for="action_taken"><?php echo $this->lang->line('xin_action_taken');?></label>
            <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('xin_action_taken');?>" name="action_taken" cols="30" rows="5" id="action_taken"><?php echo $action_taken;?></textarea>
          </div>
        </div>
      </div>
    </div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="display: table-cell;"><?php echo html_entity_decode($description);?></td>
			...
			<tr>
        <th><?php echo $this->lang->line('xin_action_taken');?></th>
        <td style="display: table-cell;"><?php echo html_entity_decode($action_taken);?></td>
      </tr>
    </tbody>
  </table>
</div>
