...
<!-- animate -->
<link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url();?>skin/hrms_assets/css/hrms/animate.css">
<link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url();?>skin/hrms_assets/css/hrms/xin_login_3.css">
      ...
      <div class="row">
        <div class="col-md-7 col-lg-8 authfy-panel-right hidden-xs hidden-sm">
          <div class="hero-heading">
            <div class="headline">
              <h3><?php echo $this->lang->line('xin_hrms_welcome');?> <?php echo $company[0]->company_name;?></h3>
              <p><?php echo $this->lang->line('xin_hrms_hr_system_login_panel');?></p>
        ...
        <div class="col-xs-12 col-sm-7 col-md-5 col-lg-4 authfy-panel-left">
          ...
          <div class="brand-logo text-center">
            <img style="max-height: 70px;" src="<?php echo base_url();?>uploads/logo/signin/<?php echo $company[0]->sign_in_logo;?>" alt="hrms-logo">
          </div><!-- ./brand-logo -->
          <!-- login start -->
          <div class="authfy-login">
            ...
            <div class="authfy-panel panel-login text-center active">
              <div class="authfy-heading">
                <h3 class="auth-title"><?php echo $this->lang->line('xin_hrms_login_to_your_account');?></h3>
              </div>
              <div class="row">
                <div class="col-xs-12 col-sm-12">
                  <?php $attributes = array('class' => 'form-hrms', 'name' => 'hrm-form', 'id' => 'hrm-form', 'data-redirect' => 'dashboard',
                    ...
                    <div class="form-group">
                      <?php echo form_button(array('name' => 'hrms_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-lg save', 'content' => '<i class="fa fa-lock"></i> '.$this->lang->line('xin_login'))); ?>
                    </div>
                  <?php echo form_close(); ?>
                </div>
              </div>
...
<!-- jQuery 3 --> 
<script src="<?php echo base_url();?>skin/hrms_assets/theme_assets/bower_components/jquery/dist/jquery.min.js"></script> 
<!-- Bootstrap 3.3.7 --> 
<script src="<?php echo base_url();?>skin/hrms_assets/theme_assets/bower_components/bootstrap/dist/js/bootstrap.min.js"></script> 
...
<script type="text/javascript" src="<?php echo base_url();?>skin/hrms_assets/hrms_scripts/xin_login.js"></script> 
<script type="text/javascript">
$(document).ready(function(){
