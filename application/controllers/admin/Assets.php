   ...
   /*Function to set JSON output*/
	...
	public function asset_read()
	{
		...
		$data = array(
				...
				'asset_value' => $result[0]->asset_value,
	...
	public function add_asset() {
		...
		if($this->input->post('category_id')==='') {
        	...
        	$Return['error'] = $this->lang->line('xin_error_employee_id');
                ...
                else if($this->input->post('asset_value')==='') {
        	$Return['error'] = $this->lang->line('xin_error_asset_value');
		...
		$module_attributes = $this->Custom_fields_model->assets_hrms_module_attributes();
