...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/timesheet/tasks/');?>" data-link-data="<?php echo site_url('admin/timesheet/tasks/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fab fa-fantasy-flight-games"></span> <?php echo $this->lang->line('left_tasks');?>
    ...
    <li class="nav-item done"> <a href="<?php echo site_url('admin/project/tasks_calendar/');?>" data-link-data="<?php echo site_url('admin/project/tasks_calendar/');?>" class="mb-3 nav-link hrms-link">
