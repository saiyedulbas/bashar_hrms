...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/payroll/generate_payslip/');?>" data-link-data="<?php echo site_url('admin/payroll/generate_payslip/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fa fa-calculator"></span> <?php echo $this->lang->line('left_payroll');?>
      <div class="text-muted small"><?php echo $this->lang->line('left_generate_payslip');?></div>
      </a> </li>
       <li class="nav-item clickable"> <a href="<?php echo site_url('admin/payroll/import/');?>" class="mb-3 nav-link hrms-link" data-link-data="<?php echo site_url('admin/payroll/import/');?>"> <span class="sw-icon ion ion-md-unlock"></span> <?php echo $this->lang->line('xin_import_payslip');?>
      <div class="text-muted small"><?php echo $this->lang->line('left_import_payslip');?></div>
      </a> </li>
    <?php } ?>
    <?php if(in_array('37',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/payroll/payment_history/');?>" data-link-data="<?php echo site_url('admin/payroll/payment_history/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon ion ion-ios-cash"></span> <?php echo $this->lang->line('xin_payslip_history');?>
    ...
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/payroll/advance_salary/');?>" data-link-data="<?php echo site_url('admin/payroll/advance_salary/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon ion ion-ios-cash"></span> <?php echo $this->lang->line('xin_advance_salary');?>
      <div class="text-muted small"><?php echo $this->lang->line('xin_setup');?> <?php echo $this->lang->line('xin_advance_salary');?></div>
      </a> </li>
    <?php } ?>
    <?php if(in_array('473',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/payroll/bonous_type/');?>" data-link-data="<?php echo site_url('admin/payroll/bonous_type/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon ion ion-ios-cash"></span> <?php echo $this->lang->line('xin_bonous_type');?>
      <div class="text-muted small"><?php echo $this->lang->line('xin_setup');?> <?php echo $this->lang->line('xin_bonous_type');?></div>
      </a> </li>
    <?php } ?>
       <?php if(in_array('473',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/payroll/employee_bonous/');?>" data-link-data="<?php echo site_url('admin/payroll/employee_bonous/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon ion ion-ios-cash"></span> <?php echo $this->lang->line('xin_employee_bonous');?>
      <div class="text-muted small"><?php echo $this->lang->line('xin_setup');?> <?php echo $this->lang->line('xin_employee_bonous');?></div>
      </a> </li>
    <?php } ?>
      <?php if(in_array('473',$role_resources_ids)) { ?>
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/payroll/employee_leave_encashment/');?>" data-link-data="<?php echo site_url('admin/payroll/employee_leave_encashment/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon ion ion-ios-cash"></span> <?php echo $this->lang->line('xin_employee_leave_encashment');?>
      <div class="text-muted small"><?php echo $this->lang->line('xin_setup');?> <?php echo $this->lang->line('xin_employee_leave_encashment');?></div>
      </a> </li>
    <?php } ?>
  </ul>
</div>
