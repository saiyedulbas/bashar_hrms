...
<!--		<p>Morbi eros bibendum lorem ipsum dolor pellentesque pellentesque bibendum. </p>-->
		...
		<ul class="contact-informations">
			<li>House#434, Road#7, </li>
			<li>DOHS Baridhara</li>
		</ul>

		<ul class="contact-informations second">
			<li><i class="fa fa-phone"></i> <p> +88 02 8412321</p></li>
			<li><i class="fa fa-envelope"></i> <p>info@ulkasemi.com</p></li>
			<li><i class="fa fa-globe"></i> <p>https://ulkasemi.tforcehrms.com/</p></li>
		</ul>
