...
class Custom_fields extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$data['title'] = $this->lang->line('xin_hrms_custom_fields').' | '.$this->Xin_model->site_title();
		$data['all_countries'] = $this->Xin_model->get_countries();
		$data['all_companies'] = $this->Xin_model->get_companies();
		$data['all_employees'] = $this->Xin_model->all_employees();
		$data['breadcrumbs'] = $this->lang->line('xin_hrms_custom_fields');
    ...
    public function custom_fields_list() {
		...
		$custom_fields = $this->Custom_fields_model->get_hrms_module_attributes();
		$role_resources_ids = $this->Xin_model->user_role_resource();
		$data = array();
	...
	public function read_info()
	{
       ...
       // $data['all_countries'] = $this->xin_model->get_countries();
		$result = $this->Custom_fields_model->read_hrms_module_attributes($id);
		$data = array(
	...
	public function add_custom_field() {
		...
		if($this->input->post('module_id')==='') {
			...
			$Return['error'] = $this->lang->line('xin_hrms_field_label_error');
		} else if($this->input->post('priority')==='') {
			$Return['error'] = $this->lang->line('xin_hrms_field_priority_error');
		}
		...
		if ($result) {
			...
			$Return['result'] = $this->lang->line('xin_hrms_field_added_success');
		} else {
	...
	public function update() {
		...
		if ($result == TRUE) {
			$Return['result'] = $this->lang->line('xin_hrms_field_updated_success');
		} else {
			$Return['error'] = $this->lang->line('xin_error_msg');
		}
		$this->output($Return);
	...
	public function delete() {
		if($this->input->post('is_ajax')==2) {
			...
			if(isset($id)) {
				$Return['result'] = $this->lang->line('xin_hrms_field_deleted_success');
			} else {
				$Return['error'] = $this->lang->line('xin_error_msg');
			}
			$this->output($Return);
