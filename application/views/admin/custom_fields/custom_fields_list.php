...
<div class="card mb-4 <?php echo $get_animate;?>">
  <div id="accordion">
    <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('xin_add_new');?></strong> <?php echo $this->lang->line('xin_hrms_custom_field');?></span>
      ...
      <div class="card-body">
        ...
        <div class="form-body">
          <div class="row">
            <div class="col-md-3">  
                  <div class="form-group">
                    <label for="module_id"><?php echo $this->lang->line('xin_modules');?><i class="hrms-asterisk">*</i></label>
             ...
             <div class="col-md-3">
              <div class="form-group">
                <label for="name"><?php echo $this->lang->line('xin_name');?><i class="hrms-asterisk">*</i></label>
                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_name');?>" name="attribute" type="text">
              </div>
             </div>
             <div class="col-md-3"> 
              <div class="form-group">
                <label for="email"><?php echo $this->lang->line('xin_hrms_field_label');?><i class="hrms-asterisk">*</i></label>
                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_hrms_field_label');?>" name="attribute_label" type="text">
              </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
                <label for="priority"><?php echo $this->lang->line('xin_p_priority');?><i class="hrms-asterisk">*</i></label>
          ...
          <div class="row">
             <div class="col-md-3">  
                  <div class="form-group">
                    <label for="validation"><?php echo $this->lang->line('xin_hrms_field_validation');?><i class="hrms-asterisk">*</i></label>
             ...
             <div class="col-md-3">      
              <div class="form-group">
                    <label for="attribute_type"><?php echo $this->lang->line('xin_hrms_field_types');?><i class="hrms-asterisk">*</i></label>
...
<div class="card <?php echo $get_animate;?>">
  <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('xin_list_all');?></strong> <?php echo $this->lang->line('xin_hrms_custom_fields');?></span> </div>
  <div class="card-body">
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            ...
            <th><?php echo $this->lang->line('xin_hrms_field_label');?></th>
            <th><?php echo $this->lang->line('xin_hrms_field_types');?></th>
            <th><?php echo $this->lang->line('xin_hrms_field_validation');?></th>
