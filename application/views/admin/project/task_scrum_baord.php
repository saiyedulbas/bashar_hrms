...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/project/tasks_scrum_board/');?>" data-link-data="<?php echo site_url('admin/project/tasks_scrum_board/');?>" class="mb-3 nav-link hrms-link">
