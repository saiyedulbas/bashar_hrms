  ...
  <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="email" placeholder="<?php echo $this->lang->line('xin_acc_payee_email'); ?>" value="<?php echo $email; ?>">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="credit_account" placeholder="<?php echo $this->lang->line('xin_credit_account'); ?>" value="<?php echo $credit_account; ?>">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="bank_name" placeholder="<?php echo $this->lang->line('xin_bank_name'); ?>" value="<?php echo $bank_name; ?>">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="routing_no"><?php echo $this->lang->line('xin_routing_no'); ?></label>
                <input type="text" class="form-control" name="routing_no" placeholder="<?php echo $this->lang->line('xin_routing_no'); ?>" value="<?php echo $routing_no; ?>">
            </div>
        </div>
