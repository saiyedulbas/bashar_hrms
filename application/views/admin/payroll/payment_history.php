...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/payroll/generate_payslip/');?>" data-link-data="<?php echo site_url('admin/payroll/generate_payslip/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fa fa-calculator"></span> <?php echo $this->lang->line('left_payroll');?>
      <div class="text-muted small"><?php echo $this->lang->line('left_generate_payslip');?></div>
      </a> </li>
      <?php } ?>
    <?php if(in_array('37',$role_resources_ids)) { ?>  
    <li class="nav-item active"> <a href="<?php echo site_url('admin/payroll/payment_history/');?>" data-link-data="<?php echo site_url('admin/payroll/payment_history/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon ion ion-ios-cash"></span> <?php echo $this->lang->line('xin_payslip_history');?>
...
<div class="ui-bordered px-4 pt-4 mb-4">
  ...
  <div class="form-row">
    ...
    <div class="col-md mb-4">
      <label class="form-label"><?php echo $this->lang->line('xin_select_start_month');?></label>
      <input type="text" class="form-control hr_month_year" name="salary_month" id="salary_month" placeholder="<?php echo $this->lang->line('xin_select_start_month');?>" value="<?php echo date('Y-m');?>" />
    </div>
    <div class="col-md mb-4">
      <label class="form-label"><?php echo $this->lang->line('xin_select_end_month');?></label>
      <input type="text" class="form-control hr_month_year" name="salary_end_month" id="salary_end_month" placeholder="<?php echo $this->lang->line('xin_select_end_month');?>" value="<?php echo date('Y-m');?>" />
    </div>
     <div class="col-md mb-4">
      <label class="form-label"><?php echo $this->lang->line('xin_approval_status');?></label>
       <select class="form-control" id="status" name="status" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_approval_status');?>">
        <option value="2"><?php echo $this->lang->line('xin_approved');?></option>
        <option value="1"><?php echo $this->lang->line('xin_first_approved');?></option>
