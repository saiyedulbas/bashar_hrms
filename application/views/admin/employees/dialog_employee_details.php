...
<div class="modal-footer"> <?php echo form_button(array('data-dismiss' => 'modal', 'type' => 'button', 'class' => 'btn btn-secondary', 'content' => '<i class="fas fa-check-square"></i> '.$this->lang->line('xin_close'))); ?> <?php echo form_button(array('name' => 'hrms_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fas fa-check-square"></i> '.$this->lang->line('xin_update'))); ?> </div>
<?php echo form_close(); ?> 
...
<div class="modal-body">
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="form-group">
        <label for="expiry_date" class="control-label"><?php echo $this->lang->line('xin_expiry_date');?><i class="hrms-asterisk">*</i></label>
...
<?php echo form_close(); ?> 
<!--<link rel="stylesheet" href="http://localhost/hrms_final/skin/hrms_assets/theme_assets/bower_components/select2/dist/css/select2.min.css">
<script src="http://localhost/hrms_final/skin/hrms_assets/vendor/select2/dist/js/select2.min.js"></script>--> 
<script type="text/javascript">
$(document).ready(function(){				
	$('[data-plugin="select_hrm"]').select2($(this).attr('data-options'));
	$('[data-plugin="select_hrm"]').select2({ width:'100%' });
...
<div class="modal-body">
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="form-group">
        <label for="from_date"><?php echo $this->lang->line('xin_e_details_frm_date');?><i class="hrms-asterisk">*</i></label>
      ...
      <div class="form-group">
        <label for="to_date"><?php echo $this->lang->line('xin_e_details_to_date');?><i class="hrms-asterisk">*</i></label>
...
<div class="modal-body">
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        <label for="allowance_title"><?php echo $this->lang->line('dashboard_xin_title');?><i class="hrms-asterisk">*</i></label>
    ...
    <div class="col-md-2">
      <div class="form-group">
        <label for="allowance_amount" class="control-label"><?php echo $this->lang->line('xin_amount');?><i class="hrms-asterisk">*</i></label>
...
<div class="modal-body">
  <div class="row">
    ...
    <div class="col-md-2">
      <div class="form-group">
        <label for="amount" class="control-label"><?php echo $this->lang->line('xin_amount');?><i class="hrms-asterisk">*</i></label>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="form-group">
        ...
        <input class="form-control" placeholder="Order" name="ordering" type="text" value="<?php echo $ordering;?>">
      </div>
    </div>
    <div class="col-md-3">
      <div class="form-group">
...
<?php }else if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='eprofessional_training_info' && $_GET['type']=='eprofessional_training_info'){
?>
<div class="modal-header"> <?php echo form_button(array('aria-label' => 'Close', 'data-dismiss' => 'modal', 'type' => 'button', 'class' => 'close', 'content' => '<span aria-hidden="true">×</span>')); ?>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('xin_e_details_edit_professional_training');?></h4>
</div>
<?php $attributes = array('name' => 'eprofessional_training_info', 'id' => 'eprofessional_training_info', 'autocomplete' => 'off');?>
<?php $hidden = array('u_basic_info' => 'UPDATE');?>
<?php echo form_open('admin/employees/eprofessional_training_info', $attributes, $hidden);?>
<?php
$edata_usr7 = array(
	'type'  => 'hidden',
	'id'  => 'user_id',
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <select required="required" class="form-control" name="training_category" id="training_category" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_training_training_category');?>">
            ...
            <option <?php if($category->id==$training_category){echo 'selected';}?> value="<?php echo $category->id;?>"><?php echo $category->title;?></option>
            <?php } ?>
          </select>
      </div>
    </div>
   <div class="col-md-6">
    <div class="form-group">
      ...
      <input required="required" class="form-control" value="<?php echo $title; ?>" placeholder="<?php echo $this->lang->line('xin_training_title');?>" name="title" type="text" value="" id="training_title">
    </div>
  </div>
  <div class="col-md-6">
    <div class="form-group">
      <label for="training_institute"><?php echo $this->lang->line('xin_training_institute');?><i class="hrms-asterisk">*</i></label>
      <input required="required" class="form-control" value="<?php echo $institute; ?>" placeholder="<?php echo $this->lang->line('xin_training_institute');?>" name="institute" type="text" value="" id="training_institute">
    </div>
  </div>
 <div class="col-md-6">
    <div class="form-group">
      <label for="training_time_period"><?php echo $this->lang->line('xin_training_time_period');?><i class="hrms-asterisk">*</i></label>
      <input required="required" class="form-control" value="<?php echo $time_period; ?>" placeholder="<?php echo $this->lang->line('xin_training_time_period');?>" name="time_period" type="text" value="" id="training_time_period">
    </div>
  </div>
    <div class="col-md-6">
    <div class="form-group">
      <label for="training_year"><?php echo $this->lang->line('xin_training_year');?><i class="hrms-asterisk">*</i></label>
      <input required="required" class="form-control" value="<?php echo $year; ?>" placeholder="<?php echo $this->lang->line('xin_training_year');?>" name="year" type="text" value="" id="training_year">
    </div>
  </div>
  </div>
</div>
...
$(document).ready(function(){			
	...
	/* Update work experience info */
	$("#eprofessional_training_info").submit(function(e){
	/*Form Submit*/
	e.preventDefault();
		var obj = $(this), action = obj.attr('name');
		$('.save').prop('disabled', true);
		$.ajax({
			type: "POST",
			url: e.target.action,
			data: obj.serialize()+"&is_ajax=14&data=eprofessional_training_info&type=eprofessional_training_info&form="+action,
			cache: false,
			success: function (JSON) {
				if (JSON.error != '') {
					toastr.error(JSON.error);
					...
					$('.edit-modal-data').modal('toggle');
					// On page load: table_contacts
					var xin_table_work_experience = $('#xin_professional_training').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("admin/employees/professional_training") ?>/"+$('#user_id').val(),
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
