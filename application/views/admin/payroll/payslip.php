    ...
    <div class="card">
      ...
      <div class="box-body">
        <div id="accordion">
              ...
              <div class="box-body ml-3 mr-3">
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      <tr>
                        <td><strong><?php echo $this->lang->line('xin_basic_salary');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($basicSalary);?></span></td>
                      </tr>
                      <tr>
                        <td><strong><?php echo $this->lang->line('xin_house_rent');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($houseRent);?></span></td>
                      </tr>
                      <tr>
                        <td><strong><?php echo $this->lang->line('xin_medical');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($medicalAllowance);?></span></td>
                      </tr>
                      <tr>
                        <td><strong><?php echo $this->lang->line('xin_conveyence');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($totalConveyence);?></span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
                      ...
                      <?php } ?>
                      <tr>
                        <td><strong><?php echo $this->lang->line('xin_acc_tax_title');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($tax_deduction);?></span></td>
                      </tr>
                      <tr>
                        <td><strong><?php echo $this->lang->line('xin_acc_total');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($statutory_deductions_amount+$tax_deduction);?></span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <!-- food allowace-->
          <div class="card hrms-payslip">
            <div class="card-header"> <a class="text-dark collapsed" data-toggle="" href="#set_daily_food_allowance" aria-expanded="true"> <strong><?php echo $this->lang->line('xin_employee_set_food_allowance');?></strong> </a> </div>
            <div id="set_daily_food_allowance" class="" data-parent="#accordion" style="">
              <div class="box-body ml-3 mr-3">
                  <p><?php echo $this->lang->line('xin_employee_set_food_allowance_month');?> <?php echo $food_allowance;?></p>
              </div>
            </div>
          </div>
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                <tbody>
                  ...
                  <?php if($total_bonous>0){?>
                  <tr>
                    <td><strong>Bonus: </strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($total_bonous);?></span></td>
                  </tr>
                  <?PHP }?>
                   <tr>
                    <td><strong>TDS : </strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($tax_deduction);?></span></td>
                  </tr>
                  ...
                  <tr>
                    <td><strong><?php echo $this->lang->line('xin_employee_set_food_allowance_month');?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($food_allowance);?></span></td>
                  </tr>
                  ...
                  <?php
					...
					$total_earning = $bs + $total_allowances + $overtime_amount + $commissions_amount + $other_payments_amount + $saudi_gosi+$food_allowance+$total_bonous;
					$total_deduction = $loan_de_amount + $statutory_deductions_amount+$tax_deduction;
