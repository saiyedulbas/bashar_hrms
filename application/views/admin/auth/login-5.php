...
<link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url();?>skin/hrms_assets/css/hrms/xin_login_2.css">
 ...
 <div class="login-logo"> 
  ...
  <div class="login-box-body">    
    ...
    <div class="row">
      ...
      <!-- /.col -->
      <div class="col-xs-12"> <?php echo form_button(array('name' => 'hrms_form', 'type' => 'submit', 'class' => 'btn btn-primary btn-block btn-flat save', 'content' => '<i class="fa fa-lock"></i> '.$this->lang->line('xin_login'))); ?> </div>
