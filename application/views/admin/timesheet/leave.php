...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active">
      <a  href="<?php echo site_url('admin/timesheet/leave/');?>" data-link-data="<?php echo site_url('admin/timesheet/leave/');?>" class="mb-3 nav-link hrms-link">
    ...
    <li class="nav-item clickable">
      <a  href="<?php echo site_url('admin/reports/employee_leave/');?>" data-link-data="<?php echo site_url('admin/reports/employee_leave/');?>" class="mb-3 nav-link hrms-link">
	  ...
	  <div class="col-md-12">
		...
		<div class="box-header  with-border">
		  <h3 class="box-title"><?php echo $this->lang->line('xin_filter');?></h3>
			  <div class="box-tools pull-right"> <a class="text-dark collapsed" data-toggle="collapse" href="#filter_hrms" aria-expanded="false">
			...
			<div class="row">
			  <div class="col-md-12">
				...
				<div class="row">
				  ...
				  <div class="col-md-1"><label for="xin_get">&nbsp;</label><button name="hrms_form" type="submit" class="btn btn-primary"><i class="fas fa-check-square"></i> <?php echo $this->lang->line('xin_get');?></button>
				</div>
				</div>
				  ...
				  <div class="col-md-6">
					...
					<div class="form-group" id="get_leave_types">
					  ...
					  <select class="form-control" id="leave_type" name="leave_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_leave_type');?>">
						...
						<?php } ?>
                                                         <?php if($earn_leave_remaining>0){?>
                                                            <option value="-99"><?php echo $this->lang->line('xin_earn_leave').' ('.$earn_leave_remaining.' '.$this->lang->line('xin_remaining').')';?></option>
                                                        <?php }?>
					  </select>
					</div>
					<div class="row">
					...
					<div class="form-group">
					  <fieldset class="form-group">
						...
						<small><?php echo $this->lang->line('xin_leave_file_type');?></small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" id="employee_alt">
                                      <label for="employee_alternate"class="control-label"><?php echo $this->lang->line('xin_alternet_employee');?></label>
                                      <select  class="form-control" name="employee_alternate" id="employee_alternate" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_choose_an_employee');?>">
                                            <option value=""></option>
                                      </select>
                                    </div>
                                 </div>
