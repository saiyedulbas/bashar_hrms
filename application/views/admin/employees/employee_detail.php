...
$additional = $this->Employees_model->read_employee_additional($eid);
$extra_curriculam = $this->Employees_model->read_employee_extra_curriculam($eid);
?>
<?php
...
<div class="mb-3 sw-container tab-content">
  <div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
    <ul class="nav nav-tabs step-anchor">
      ...
      <li class="nav-item done"> <a href="#smartwizard-2-step-7" class="mb-3 nav-link"> <span class="sw-done-icon lnr lnr-keyboard"></span> <span class="sw-icon lnr lnr-keyboard"></span> <?php echo $this->lang->line('left_salary_statement');?>
        <div class="text-muted small"><?php echo $this->lang->line('left_salary_statement');?></div>
        </a>
      </li>
    </ul>
    ...
    <div class="mb-3 sw-container tab-content">
            ...
            <div class="row no-gutters row-bordered row-border-light">
              <div class="col-md-3 pt-0">
                <div class="list-group list-group-flush account-settings-links">
                    ...
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-additional_details"> <i class="lnr lnr-lock text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_additional');?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#professional-training"> <i class="lnr lnr-lock text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_training');?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-extra_curriculam"> <i class="lnr lnr-lock text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_extra_curriculam');?></a>
                    ...
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-cpassword"> <i class="lnr lnr-lock text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_cpassword');?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-security_level"> <i class="lnr lnr-link text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_esecurity_level_title');?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-contract"> <i class="lnr lnr-pencil text-lightest"></i> &nbsp; <?php echo $this->lang->line('xin_e_details_contract');?></a> </div>
              </div>
              <div class="col-md-9">
                <div class="tab-content">
                    ...
                    <div class="card-body">
                      ...
                      <div class="bg-white">
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="first_name"><?php echo $this->lang->line('xin_employee_first_name');?><i class="hrms-asterisk">*</i></label>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="last_name" class="control-label"><?php echo $this->lang->line('xin_employee_last_name');?><i class="hrms-asterisk">*</i></label>
                             ...
                             <div class="col-md-4">
                            <div class="form-group">
                              <label for="employee_id"><?php echo $this->lang->line('dashboard_employee_id');?><i class="hrms-asterisk">*</i></label>
                              ...
                              <div class="col-md-4">
                            <div class="form-group">
                              <label for="username"><?php echo $this->lang->line('dashboard_username');?><i class="hrms-asterisk">*</i></label>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="email" class="control-label"><?php echo $this->lang->line('dashboard_email');?><i class="hrms-asterisk">*</i></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_email');?>" name="email" type="text" value="<?php echo $email;?>">
                            </div>
                          </div>
                             <div class="col-md-4">
                            <div class="form-group">
                              <label for="e_tin" class="control-label"><?php echo $this->lang->line('e_tin');?></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('e_tin');?>" name="e_tin" type="text" value="<?php echo $e_tin;?>">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="first_name"><?php echo $this->lang->line('left_company');?><i class="hrms-asterisk">*</i></label>
                           ...
                           <div class="col-md-4">
                            <div class="form-group">
                              <label for="daily_food_allowance" class="control-label"><?php echo $this->lang->line('daily_food_allowance');?></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('daily_food_allowance');?>" name="daily_food_allowance" type="text" value="<?php echo $daily_food_allowance;?>">
                            </div>
                          </div>
                          <?php } else {?>
                          ...
                          <div class="col-md-4" id="location_ajax">
                            <div class="form-group">
                              <label for="name"><?php echo $this->lang->line('left_location');?><i class="hrms-asterisk">*</i></label>
                          ...
                          <div class="col-md-<?php echo $colmd;?>">
                            <div class="form-group" id="department_ajax">
                              <label for="department"><?php echo $this->lang->line('xin_employee_department');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-<?php echo $ncolmd;?>" id="subdepartment_ajax">
                            ...
                            <div class="form-group">
                              <label for="designation"><?php echo $this->lang->line('xin_hr_sub_department');?><i class="hrms-asterisk">*</i></label>
                          ...
                          <div class="col-md-<?php echo $ncolmd;?>">
                            <div class="form-group" id="designation_ajax">
                              <label for="designation"><?php echo $this->lang->line('xin_designation');?><i class="hrms-asterisk">*</i></label>
                          ...
                          <div class="col-md-<?php echo $ncolmd;?>">
                            <div class="form-group">
                              <label for="date_of_joining" class="control-label"><?php echo $this->lang->line('xin_employee_doj');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="role"><?php echo $this->lang->line('xin_employee_role');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="contact_no" class="control-label"><?php echo $this->lang->line('xin_contact_number');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="date_of_birth"><?php echo $this->lang->line('xin_employee_dob');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="n_id"><?php echo $this->lang->line('xin_n_id');?><i class="hrms-asterisk">*</i></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_n_id');?>" name="n_id" type="text" value="<?php echo $n_id;?>">
                            </div>
                          </div>
                      ...
                      <div class="form-actions box-footer"> <?php echo form_button(array('name' => 'hrms_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fas fa-check-square"></i> '.$this->lang->line('xin_save'))); ?> </div>
                      <?php echo form_close(); ?> </div>
                  </div>
                  <!-- additional details-->
                  <div class="tab-pane fade" id="account-additional_details">
                    <div class="card-body pb-2">
                      <?php $attributes = array('name' => 'update_additional_details', 'id' => 'update_additional_details', 'autocomplete' => 'off');?>
                      <?php $hidden = array('user_id' => $user_id, 'u_basic_info' => 'UPDATE');?>
                      <?php echo form_open_multipart('admin/employees/update_additional_details', $attributes, $hidden);?>
                      <div class="row">
                          <input type="hidden" name="employee_id" value="<?php echo $eresult[0]->user_id;?>" />
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="other_name"><?php echo $this->lang->line('e_other_name');?></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->other_name;}?>" placeholder="<?php echo $this->lang->line('e_other_name');?>" name="other_name" type="text">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="full_name"><?php echo $this->lang->line('xin_e_full_name');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->full_name;}?>" placeholder="<?php echo $this->lang->line('xin_e_full_name');?>" name="full_name" type="text">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="father_name" class="control-label"><?php echo $this->lang->line('xin_e_father_name');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->father_name;}?>" placeholder="<?php echo $this->lang->line('xin_e_father_name');?>" name="father_name" type="text">
                          </div>
                        </div>
                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="mother_name" class="control-label"><?php echo $this->lang->line('xin_e_mother_name');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->mother_name;}?>" placeholder="<?php echo $this->lang->line('xin_e_mother_name');?>" name="mother_name" type="text">
                          </div>
                        </div>
                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="spouse_name" class="control-label"><?php echo $this->lang->line('xin_e_spouse_name');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->spouse_name;}?>" placeholder="<?php echo $this->lang->line('xin_e_spouse_name');?>" name="spouse_name" type="text">
                          </div>
                        </div>
                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="no_of_child" class="control-label"><?php echo $this->lang->line('xin_e_no_of_child');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->no_of_child;}?>" placeholder="<?php echo $this->lang->line('xin_e_no_of_child');?>" name="no_of_child" type="text">
                          </div>
                        </div>
                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="pre_house_no" class="control-label"><?php echo $this->lang->line('xin_e_pre_house_no');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->pre_house_no;}?>" placeholder="<?php echo $this->lang->line('xin_e_pre_house_no');?>" name="pre_house_no" type="text">
                          </div>
                        </div>
                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="pre_street1" class="control-label"><?php echo $this->lang->line('xin_e_pre_street1');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->pre_street1;} ?>" placeholder="<?php echo $this->lang->line('xin_e_pre_street1');?>" name="pre_street1" type="text">
                          </div>
                        </div>
                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="pre_street2" class="control-label"><?php echo $this->lang->line('xin_e_pre_street2');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->pre_street2;}?>" placeholder="<?php echo $this->lang->line('xin_e_pre_street2');?>" name="pre_street2" type="text">
                          </div>
                        </div>
                          <?php $division_id=''; if($additional){$division_id=$additional->pre_city;} ?>
                          <?php $upazila_id=''; if($additional){$upazila_id=$additional->per_police_station;} ?>
                          <?php $district_id=''; if($additional){$district_id=$additional->per_district;} ?>
                          <?php $divisions = $this->Location_model->get_divisions();?>
                          <?php $districts = $this->Location_model->get_districts($division_id); ?>
                          <?php $upazilas = $this->Location_model->get_upazilas($district_id); ?>
                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="pre_city" class="control-label"><?php echo $this->lang->line('xin_e_pre_city');?><i class="hrms-asterisk">*</i></label>
                            <select class="form-control" name="pre_city" id="pre_city" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_pre_city');?>">
                                <option value=""></option>
                                <?php foreach($divisions as $division) {?>
                                <option value="<?php echo $division->id;?>" <?php if($additional){ if($additional->pre_city==$division->id){ echo 'selected';} } ?>><?php echo $division->name;?></option>
                                <?php } ?>
                              </select>
                            </div>
                        </div>
                          <div class="col-md-4">
                              <div class="form-group" id="edistrict">
                            <label for="pre_district" class="control-label"><?php echo $this->lang->line('xin_e_pre_district');?><i class="hrms-asterisk">*</i></label>
                             <select name="pre_district" id="pre_district" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_pre_district');?>">
                                <?php foreach($districts as $district) {?>
                                <option value="<?php if($district !==null){echo $district->id;}?>" <?php if($additional){ if($additional->pre_district==$district->id){ echo 'selected';} } ?>><?php echo $district->name;?></option>
                                <?php } ?>
                              </select>
                           </div>
                        </div>
                         <div class="col-md-4">
                            <div class="form-group">
                              <label for="pre_country" class="control-label"><?php echo $this->lang->line('xin_e_pre_country');?></label>
                              <select class="form-control" name="pre_country" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_pre_country');?>">
                                <option value=""><?php echo $this->lang->line('xin_select_one');?></option>
                                <?php foreach($all_countries as $country) {?>
                                <option value="<?php echo $country->country_id;?>" <?php if($additional){ if($additional->pre_country==$country->country_id){ echo 'selected';} } ?>> <?php echo $country->country_name;?></option>
                                <?php } ?>
                              </select>
                            </div>
                          </div>
                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="pre_tel" class="control-label"><?php echo $this->lang->line('xin_e_pre_tel');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->pre_tel;} ?>" placeholder="<?php echo $this->lang->line('xin_e_pre_tel');?>" name="pre_tel" type="text">
                          </div>
                        </div>
                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="pre_mobile" class="control-label"><?php echo $this->lang->line('xin_e_pre_mobile');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->pre_mobile;} ?>" placeholder="<?php echo $this->lang->line('xin_e_pre_mobile');?>" name="pre_mobile" type="text">
                          </div>
                        </div>
                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="per_house_no" class="control-label"><?php echo $this->lang->line('xin_e_per_house_no');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->per_house_no;} ?>" placeholder="<?php echo $this->lang->line('xin_e_per_house_no');?>" name="per_house_no" type="text">
                          </div>
                        </div>

                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="per_post_office" class="control-label"><?php echo $this->lang->line('xin_e_per_post_office');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->per_post_office;} ?>" placeholder="<?php echo $this->lang->line('xin_e_per_post_office');?>" name="per_post_office" type="text">
                          </div>
                        </div>
                          <div class="col-md-4">
                          <div class="form-group">
                            <label for="per_city" class="control-label"><?php echo $this->lang->line('xin_e_per_city');?><i class="hrms-asterisk">*</i></label>
                            <select class="form-control" name="per_city" id="per_city" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_per_city');?>">
                                <option value=""></option>
                                <?php foreach($divisions as $division) {?>
                                <option value="<?php echo $division->id;?>" <?php if($additional){ if($additional->per_city==$division->id){ echo 'selected';} } ?>><?php echo $division->name;?></option>
                                <?php } ?>
                              </select>
                          </div>
                        </div>
                          <div class="col-md-4">
                          <div class="form-group" id="eper_district">
                            <label for="per_district" class="control-label"><?php echo $this->lang->line('xin_e_per_district');?><i class="hrms-asterisk">*</i></label>
                             <select name="per_district" id="per_district" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_per_district');?>">
                                <?php foreach($districts as $district) {?>
                                <option value="<?php if($district !==null){echo $district->id;}?>" <?php if($additional){ if($additional->pre_district==$district->id){ echo 'selected';} } ?>><?php echo $district->name;?></option>
                                <?php } ?>
                              </select>
                           ...
                           <div class="col-md-4">
                          <div class="form-group" id="eper_police_station">
                            <label for="per_police_station" class="control-label"><?php echo $this->lang->line('xin_e_per_police_station');?><i class="hrms-asterisk">*</i></label>
                            <select name="per_police_station" id="per_police_station" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_per_police_station');?>">
                                <?php foreach($upazilas as $upazila) {?>;
                                <option value="<?php if($upazila !==null){echo $upazila->id;}?>" <?php if($additional){ if($additional->per_police_station==$upazila->id){ echo 'selected';} } ?>><?php echo $upazila->name;?></option>
                                <?php } ?>
                              </select>
                           ...
                           <div class="col-md-4">
                          <div class="form-group">
                            <label for="per_country" class="control-label"><?php echo $this->lang->line('xin_e_per_country');?><i class="hrms-asterisk">*</i></label>
                           <select class="form-control" name="per_country" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_per_country');?>">
                                <option value=""><?php echo $this->lang->line('xin_select_one');?></option>
                                <?php foreach($all_countries as $country) {?>
                                <option value="<?php echo $country->country_id;?>" <?php if($additional){ if($additional->per_country==$country->country_id){ echo 'selected';} } ?>> <?php echo $country->country_name;?></option>
                                <?php } ?>
                              </select>
                           </div>
                        </div>
                           <div class="col-md-4">
                          <div class="form-group">
                            <label for="per_tel" class="control-label"><?php echo $this->lang->line('xin_e_per_tel');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->per_tel;} ?>" placeholder="<?php echo $this->lang->line('xin_e_per_tel');?>" name="per_tel" type="text">
                          </div>
                        </div>
                           <div class="col-md-4">
                          <div class="form-group">
                            <label for="per_mobile" class="control-label"><?php echo $this->lang->line('xin_e_per_mobile');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" value="<?php if($additional){echo $additional->per_mobile;} ?>" placeholder="<?php echo $this->lang->line('xin_e_per_mobile');?>" name="per_mobile" type="text">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <div class="form-actions"> <?php echo form_button(array('name' => 'hrms_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fas fa-check-square"></i> '.$this->lang->line('xin_save'))); ?> </div>
                          </div>
                        </div>
                      </div>
                      <?php echo form_close(); ?> </div>
                  ...
                  <div class="tab-pane fade" id="account-extra_curriculam">
                    <div class="card-body pb-2">
                      <?php $attributes = array('name' => 'update_extra_curriculams', 'id' => 'update_extra_curriculams', 'autocomplete' => 'off');?>
                      <?php $hidden = array('user_id' => $user_id, 'u_basic_info' => 'UPDATE');?>
                      <?php echo form_open_multipart('admin/employees/update_extra_curriculams', $attributes, $hidden);?>
                      <div class="row">
                          <input type="hidden" name="employee_id" value="<?php echo $eresult[0]->user_id;?>" />
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="interest"><?php echo $this->lang->line('xin_employee_interest');?></label>
                            <textarea  class="form-control" name="interest" id="interest"><?php if($extra_curriculam){echo $extra_curriculam->interest;}?> </textarea>
                           </div>
                        </div>
                           <div class="col-md-6">
                          <div class="form-group">
                            <label for="hobbies"><?php echo $this->lang->line('xin_employee_hobbies');?></label>
                            <textarea class="form-control" name="hobbies" id="hobbies"><?php if($extra_curriculam){echo $extra_curriculam->hobbies;}?> </textarea>
                           </div>
                        </div>
                  ...
                  <div class="tab-pane fade" id="professional-training">
                    <div class="box">
                      <div class="card-header with-elements"> <span class="card-header-title mr-2"> <strong> <?php echo $this->lang->line('xin_list_all');?></strong> <?php echo $this->lang->line('xin_e_training');?> </span> </div>
                      <div class="card-body">
                        <div class="box-datatable table-responsive">
                          <table class="table table-striped table-bordered dataTable" id="xin_professional_training" style="width:100%;">
                            <thead>
                              <tr>
                                <th><?php echo $this->lang->line('xin_action');?></th>
                                <th><?php echo $this->lang->line('xin_training_training_category');?></th>
                                <th><?php echo $this->lang->line('xin_training_title');?></th>
                                <th><?php echo $this->lang->line('xin_training_institute');?></th>
                                <th><?php echo $this->lang->line('xin_training_time_period');?></th>
                                <th><?php echo $this->lang->line('xin_training_year');?></th>
                              </tr>
                            </thead>
                          </table>
                        </div>
                    ...
                    <div class="card-header with-elements"> <span class="card-header-title mr-2"> <strong> <?php echo $this->lang->line('xin_add_new');?></strong> <?php echo $this->lang->line('xin_e_training');?> </span> </div>
                    <div class="card-body pb-2">
                      <?php $attributes = array('name' => 'add_professional_training', 'id' => 'professional_training', 'autocomplete' => 'off');?>
                      <?php $hidden = array('u_basic_info' => 'UPDATE');?>
                      <?php echo form_open('admin/employees/add_professional_training', $attributes, $hidden);?>
                      <?php
							  $data_usr4 = array(
									'type'  => 'hidden',
									'name'  => 'user_id',
						  ...
						  ?>
                      <div class="row">
                          <?php $training_categories = $this->Location_model->get_training_categories();?>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="training_category"><?php echo $this->lang->line('xin_training_training_category');?><i class="hrms-asterisk">*</i></label>
                            <select required="required" class="form-control" name="training_category" id="training_category" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_training_training_category');?>">
                                <option value=""></option>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="training_title"><?php echo $this->lang->line('xin_training_title');?><i class="hrms-asterisk">*</i></label>
                            <input required="required" class="form-control" placeholder="<?php echo $this->lang->line('xin_training_title');?>" name="title" type="text" value="" id="training_title">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="training_institute"><?php echo $this->lang->line('xin_training_institute');?><i class="hrms-asterisk">*</i></label>
                            <input required="required" class="form-control" placeholder="<?php echo $this->lang->line('xin_training_institute');?>" name="institute" type="text" value="" id="training_institute">
                          </div>
                        </div>
                       <div class="col-md-6">
                          <div class="form-group">
                            <label for="training_time_period"><?php echo $this->lang->line('xin_training_time_period');?><i class="hrms-asterisk">*</i></label>
                            <input required="required" class="form-control" placeholder="<?php echo $this->lang->line('xin_training_time_period');?>" name="time_period" type="text" value="" id="training_time_period">
                          </div>
                        </div>
                          <div class="col-md-6">
                          <div class="form-group">
                            <label for="training_year"><?php echo $this->lang->line('xin_training_year');?><i class="hrms-asterisk">*</i></label>
                            <input required="required" class="form-control" placeholder="<?php echo $this->lang->line('xin_training_year');?>" name="year" type="text" value="" id="training_year">
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="tab-pane fade" id="account-profile_picture">
                    <div class="card-body pb-2">
                      ...
                      <div class="bg-white">
                          ...
                          <div class="col-md-12">
                            <div class='form-group'>
                              <fieldset class="form-group">
                                <label for="logo"><?php echo $this->lang->line('xin_browse');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="form-action box-footer"> <?php echo form_button(array('name' => 'hrms_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fas fa-check-square"></i> '.$this->lang->line('xin_save'))); ?> </div>
                      </div>
                      <?php echo form_close(); ?> </div>
                  </div>
                  <div class="tab-pane fade" id="account-immigration">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="relation"><?php echo $this->lang->line('xin_e_details_document');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="document_number" class="control-label"><?php echo $this->lang->line('xin_employee_document_number');?><i class="hrms-asterisk">*</i></label>
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="issue_date" class="control-label"><?php echo $this->lang->line('xin_issue_date');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control date" readonly="readonly" placeholder="Issue Date" name="issue_date" type="text">
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="expiry_date" class="control-label"><?php echo $this->lang->line('xin_e_details_doe');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <fieldset class="form-group">
                              <label for="logo"><?php echo $this->lang->line('xin_e_details_document_file');?><i class="hrms-asterisk">*</i></label>
                  ...
                  <div class="tab-pane fade" id="account-contacts">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="relation"><?php echo $this->lang->line('xin_e_details_relation');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            <label for="work_email" class="control-label"><?php echo $this->lang->line('dashboard_email');?><i class="hrms-asterisk">*</i></label>
                      ...
                      <div class="row">
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="name" class="control-label"><?php echo $this->lang->line('xin_name');?><i class="hrms-asterisk">*</i></label>
                      ...
                      <div class="row">
                        <div class="col-md-5">
                          <div class="form-group">
                            <label for="work_phone"><?php echo $this->lang->line('xin_phone');?><i class="hrms-asterisk">*</i></label>
                            <div class="row">
                              <div class="col-md-8">
                  ...
                  <div class="tab-pane fade" id="account-qualification">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="name"><?php echo $this->lang->line('xin_e_details_inst_name');?><i class="hrms-asterisk">*</i></label>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="from_year" class="control-label"><?php echo $this->lang->line('xin_e_details_timeperiod');?><i class="hrms-asterisk">*</i></label>
                            <div class="row">
                              <div class="col-md-6">
                  ...
                  <div class="tab-pane fade" id="account-experience">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="company_name"><?php echo $this->lang->line('xin_company_name');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="post"><?php echo $this->lang->line('xin_e_details_post');?><i class="hrms-asterisk">*</i></label>
                  ...
                  <div class="tab-pane fade" id="account-document">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="relation"><?php echo $this->lang->line('xin_e_details_dtype');?><i class="hrms-asterisk">*</i></label>
                            <select name="document_type_id" id="document_type_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_details_choose_dtype');?>">
                              <option value=""></option>
                              <?php foreach($all_document_types as $document_type) {?>
                              <option value="<?php echo $document_type->document_type_id;?>"> <?php echo $document_type->document_type;?></option>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="date_of_expiry" class="control-label"><?php echo $this->lang->line('xin_e_details_doe');?><i class="hrms-asterisk">*</i></label>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="title" class="control-label"><?php echo $this->lang->line('xin_e_details_dtitle');?><i class="hrms-asterisk">*</i></label>
                  ...
                  <div class="tab-pane fade" id="account-baccount">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="account_title"><?php echo $this->lang->line('xin_e_details_acc_title');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="account_number"><?php echo $this->lang->line('xin_e_details_acc_number');?><i class="hrms-asterisk">*</i></label>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="bank_name"><?php echo $this->lang->line('xin_e_details_bank_name');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="bank_code"><?php echo $this->lang->line('xin_e_details_bank_code');?><i class="hrms-asterisk">*</i></label>
                  ...
                  <div class="tab-pane fade" id="account-cpassword">
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="new_password"><?php echo $this->lang->line('xin_e_details_enpassword');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" placeholder="<?php echo $this->lang->line('xin_e_details_enpassword');?>" name="new_password" type="password">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="new_password_confirm" class="control-label"><?php echo $this->lang->line('xin_e_details_ecnpassword');?><i class="hrms-asterisk">*</i></label>
                  ...
                  <div class="tab-pane fade" id="account-security_level">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="account_title"><?php echo $this->lang->line('xin_esecurity_level_title');?><i class="hrms-asterisk">*</i></label>
                ...
                <div class="tab-content">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="bg-white">
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="wages_type"><?php echo $this->lang->line('xin_employee_type_wages');?><i class="hrms-asterisk">*</i></label>
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="basic_salary"><?php echo $this->lang->line('xin_salary_title');?><i class="hrms-asterisk">*</i></label>
                  ...
                  <div class="tab-pane fade" id="account-allowances">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="is_allowance_taxable"><?php echo $this->lang->line('xin_salary_allowance_options');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="amount_option"><?php echo $this->lang->line('xin_amount_option');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="account_title"><?php echo $this->lang->line('dashboard_xin_title');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="account_number"><?php echo $this->lang->line('xin_amount');?><i class="hrms-asterisk">*</i></label>
                  ...
                  <div class="tab-pane fade" id="account-commissions">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="col-md-3">
                          <div class="form-group">
                            <label for="is_commission_taxable"><?php echo $this->lang->line('xin_salary_commission_options');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="title"><?php echo $this->lang->line('dashboard_xin_title');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_xin_title');?>" name="title" type="text" value="" id="title">
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="amount"><?php echo $this->lang->line('xin_amount');?><i class="hrms-asterisk">*</i></label>
                  ...
                  <div class="tab-pane fade" id="account-loan_deductions">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="loan_options"><?php echo $this->lang->line('xin_salary_loan_options');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="month_year"><?php echo $this->lang->line('dashboard_xin_title');?><i class="hrms-asterisk">*</i></label>
                            <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_xin_title');?>" name="loan_deduction_title" type="text">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="edu_role"><?php echo $this->lang->line('xin_employee_monthly_installment_title');?><i class="hrms-asterisk">*</i></label>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="month_year"><?php echo $this->lang->line('xin_start_date');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="end_date"><?php echo $this->lang->line('xin_end_date');?><i class="hrms-asterisk">*</i></label>
                  ...
                  <div class="tab-pane fade" id="account-statutory_deductions">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="statutory_options"><?php echo $this->lang->line('xin_salary_sd_options');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="col-md-2">
                          <div class="form-group">
                            <label for="ordering">Order<i class="hrms-asterisk">*</i></label>
                            <input class="form-control" placeholder="Ordering" name="ordering" type="text" value="" id="ordering">
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="amount"><?php echo $this->lang->line('xin_amount');?>
                              <i class="hrms-asterisk">*</i> </label>
                            <input class="form-control" placeholder="<?php echo $this->lang->line('xin_amount');?>" name="amount" type="text" value="" id="amount">
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="tab-pane fade" id="account-other_payment">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="is_otherpayment_taxable"><?php echo $this->lang->line('xin_salary_otherpayment_options');?><i class="hrms-asterisk">*</i></label>
                  ...
                  <div class="tab-pane fade" id="account-overtime">
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="overtime_type"><?php echo $this->lang->line('xin_employee_overtime_title');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="no_of_days"><?php echo $this->lang->line('xin_employee_overtime_no_of_days');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="overtime_hours"><?php echo $this->lang->line('xin_employee_overtime_hour');?><i class="hrms-asterisk">*</i></label>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="overtime_rate"><?php echo $this->lang->line('xin_employee_overtime_rate');?><i class="hrms-asterisk">*</i></label>
            ...
            <div class="col-md-12">
              <div class="tab-content">
                ...
                <div class="card <?php echo $get_animate;?>">
                  ...
                  <div class="card-body">
                    <div class="box-datatable table-responsive">
                      <table class="datatables-demo table table-striped table-bordered xin_hrms_table" id="xin_hr_table">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <?php
							...
							if($r->is_half_day == 1){
							$duration = $this->Xin_model->set_date_format($r->from_date).' '.$this->lang->line('dashboard_to').' '.$this->Xin_model->set_date_format($r->to_date).'<br>'.$this->lang->line('xin_hrms_total_days').': '.$this->lang->line('xin_hr_leave_half_day');
							} else {
								$duration = $this->Xin_model->set_date_format($r->from_date).' '.$this->lang->line('dashboard_to').' '.$this->Xin_model->set_date_format($r->to_date).'<br>'.$this->lang->line('xin_hrms_total_days').': '.$no_of_days;
							}
        ...
        <div class="cards-body">
          <div class="card overflow-hidden">
            <div class="row no-gutters row-bordered row-border-light">
              <div class="col-md-3 pt-0">
                <div class="list-group list-group-flush account-settings-links">
                    <a class="list-group-item list-group-item-action active" data-toggle="list" href="#account-awards"> <i class="lnr lnr-strikethrough text-lightest"></i> &nbsp; <?php echo $this->lang->line('left_awards');?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-travels"> <i class="lnr lnr-car text-lightest"></i> &nbsp; <?php echo $this->lang->line('left_travels');?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-training"> <i class="lnr lnr-graduation-hat text-lightest"></i> &nbsp; <?php echo $this->lang->line('left_training');?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-tickets"> <i class="lnr lnr-location text-lightest"></i> &nbsp; <?php echo $this->lang->line('left_tickets');?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-transfers"> <i class="lnr lnr-store text-lightest"></i> &nbsp; <?php echo $this->lang->line('left_transfers');?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-promotions"> <i class="lnr lnr-tag text-lightest"></i> &nbsp; <?php echo $this->lang->line('left_promotions');?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-complaints"> <i class="lnr lnr-file-add text-lightest"></i> &nbsp; <?php echo $this->lang->line('left_complaints');?></a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-warnings"> <i class="lnr lnr-paw text-lightest"></i> &nbsp; <?php echo $this->lang->line('left_warnings');?></a>
                </div>
              </div>
              <div class="col-md-9">
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="account-travels">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="box-datatable table-responsive">
                          <table class="datatables-demo table table-striped table-bordered xin_hrms_table">
                            <thead>
                              <tr>
                                <th><?php echo $this->lang->line('xin_view');?></th>
      ...
      <div id="smartwizard-2-step-6" class="card animated fadeIn tab-pane step-content mt-3" style="display: none;">
        ...
        <!-- Salary statement start-->
        <div id="smartwizard-2-step-7" class="card animated fadeIn tab-pane step-content mt-3" style="display: none;">
        <div class="card">
          <div class="card-header with-elements"> <span class="card-header-title mr-2"><?php echo $this->lang->line('left_salary_statement');?> </span> </div>
          ...
          <div class="card-body">
                ...
                <div class="col-md-2">
                   <div class="form-group">
                     ...
                     <select name="year" id="year" class="from-account form-control" data-plugin="select_hrm" >
                       ...
                       <option <?php if($year==$current_year){echo 'selected';}?> value="<?php echo $year;?>" ><?php echo $year-1;?> - <?php echo $year;?></option>
                       <?php } ?>
                     </select>
                   </div>
                 </div>
                  ...
                  <div class="col-md-3">
                      <div class="form-actions" style="margin-top:9%">
                          <button id="salary_statement" type="button" class="btn btn-primary"> <i class="fa fa-search"></i> <?php echo $this->lang->line('xin_search'); ?> </button>
                    </div>
                  </div>

                  <div class="col-md mb-2">
                      <label class="form-label"><?php echo $this->lang->line('xin_select_date'); ?></label>
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('xin_select_date'); ?>" readonly id="start_date" name="start_date" type="text" value="<?php echo date('Y-m-d',strtotime('-1 year')); ?>">
                  </div>
                  <div class="col-md mb-2">
                      <label class="form-label"><?php echo $this->lang->line('xin_select_date'); ?></label>
                  ...
                  <div class="col-md-3">
                      <div class="form-actions" style="margin-top:9%">
                          <button id="salary_statement_range" type="button" class="btn btn-primary"> <i class="fa fa-search"></i> <?php echo $this->lang->line('xin_search'); ?> </button>
                    </div>
                  </div>
              </div>
          </div>
            ...
            <style media="print" type="text/css">
                #salary_statement td {margin:3px;padding:3px}
                #salary_statement th {margin:3px;padding:3px}

                #tax_return td {margin:3px;padding:3px}
                #tax_return th {margin:3px;padding:3px}
                body{margin:0px;padding:0px;background-color:#fff !important}
                @media print {
                    #salary_statement td{padding:3px}
                    #salary_statement th{padding:3px}
                ...
                @page {margin:0 -6cm;background-color:#fff !important}
                html {margin:0 6cm}
                }

            </style>
            <div id="salary_sheet_option" style="background-color:#fff !important">
