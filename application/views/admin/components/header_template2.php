...
?>
<style type="text/css">
.main-header .sidebar-toggle-hrms-chat:before {
	content: "\f0e6";
}
.main-header .sidebar-toggle-hrms-quicklinks:before {
	content: "\f00a";
}
</style>
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <?php if($system[0]->module_chat_box=='true'){?>
        <a href="<?php echo site_url('admin/chat');?>" class="sidebar-toggle sidebar-toggle-hrms-chat" role="button" title="<?php echo $this->lang->line('xin_hr_chat_box');?>">
       ...
       <?php } if($user[0]->user_role_id=='1'){?>
          <a href="javascript:void(0);" class="sidebar-toggle sidebar-toggle-hrms-quicklinks" role="button" data-toggle="modal" data-target=".modal-hrmsapps" title="<?php echo $this->lang->line('xin_quick_links');?>">	</a>
        <?php } ?> 
          ...
          <!-- User Account: style can be found in dropdown.less -->
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu <?php echo $animated;?>">
                  ...
                  <li role="presentation">
                  <a role="menuitem" tabindex="-1" href="<?php echo site_url('admin/custom_fields');?>"> <i class="fa fa-sliders"></i><?php echo $this->lang->line('xin_hrms_custom_fields');?></a></li>
                  <?php } ?>
				  <?php  if($user[0]->user_role_id==1) { ?>
                  <li role="presentation">
