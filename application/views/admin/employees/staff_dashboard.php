...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/employees/staff_dashboard/');?>" data-link-data="<?php echo site_url('admin/employees/staff_dashboard/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-done-icon ion ion-md-speedometer"></span> <span class="sw-icon ion ion-md-speedometer"></span> <?php echo $this->lang->line('hr_staff_dashboard_title');?>
    ...
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/employees/');?>" data-link-data="<?php echo site_url('admin/employees/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-done-icon fas fa-user-friends"></span> <span class="sw-icon fas fa-user-friends"></span> <?php echo $this->lang->line('dashboard_employees');?>
      ...
      <div class="row">
            ...
            <div class="table-responsive">
              <table class="table mb-0 table-dashboard">
                <tbody>
                  ...
                  <?php $j=0;foreach(hrms_office_shift() as $hr_office_shift) { ?>
                  <?php
        ...
        <div class="col-md-6">
          <div style="height:120px;">
            <canvas id="hrms_office_shifts"  style="display: block; height: 150px; width:300px;"></canvas>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-xl-6 col-md-6 align-items-strdetch"> 
    ...
    <div class="card mb-4">
      ...
      <div class="row">
            ...
            <div class="table-responsive">
              <table class="table mb-0 table-dashboard">
                <tbody>
                  ...
                  <?php $j=0;foreach(hrms_roles() as $hr_roles) { ?>
                  <?php
        ...
        <div class="col-md-6">
          <div style="height:120px;">
            <canvas id="hrms_roles"  style="display: block; height: 150px; width:300px;"></canvas>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card d-flex w-100 mb-4">
      <div class="row no-gutters row-bordered h-100">
        ...
        <div class="d-flex col-sm-6 col-md-3 col-lg-3 align-items-center"> <a href="javascript:void(0)" class="card-body media align-items-center text-body"> <i class="ion ion-md-close display-4 d-block text-primary"></i> <span class="media-body d-block ml-3"> <span class="text-big font-weight-bolder"><?php echo $this->Xin_model->set_percentage($emp_abs);?>%</span><br>
          <small class="text-muted"><?php echo $this->lang->line('xin_hrms_absent_today');?></small> </span> </a> </div>
          <?php  } ?>
          <?php if(in_array('13',$role_resources_ids)) { ?>
        <div class="d-flex col-sm-6 col-md-3 col-lg-3 align-items-center"> <a href="javascript:void(0)" class="card-body media align-items-center text-body"> <i class="ion ion-md-checkbox-outline display-4 d-block text-primary"></i> <span class="media-body d-block ml-3"> <span class="text-big font-weight-bolder"><?php echo $this->Xin_model->set_percentage($emp_work);?>%</span><br>
          <small class="text-muted"><?php echo $this->lang->line('xin_hrms_present_today');?></small> </span> </a> </div>
          <?php  } ?>
        ...
        <div class="d-flex col-sm-6 col-md-3 col-lg-3 align-items-center">
          ...
          <small class="text-muted"><?php echo $this->lang->line('xin_hrms_project_status');?></small> </span> </a> </div>
          <?php  } ?>
        ...
        <div class="d-flex col-sm-6 col-md-3 col-lg-3 align-items-center">
          ...
          <small class="text-muted"><?php echo $this->lang->line('xin_hrms_task_status');?></small> </span> </a> </div>
          <?php  } ?>
      </div>
    </div>
    <!-- / Stats + Links --> 
