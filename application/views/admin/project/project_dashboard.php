...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/project/projects_dashboard/');?>" data-link-data="<?php echo site_url('admin/project/projects_dashboard/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon ion ion-md-speedometer"></span> <?php echo $this->lang->line('dashboard_title');?>
    ...
    <li class="nav-item done"> <a href="<?php echo site_url('admin/project/projects_calendar/');?>" data-link-data="<?php echo site_url('admin/project/projects_calendar/');?>" class="mb-3 nav-link hrms-link"> <span class="sw-icon fas fa-calendar-alt"></span> <?php echo $this->lang->line('xin_acc_calendar');?>
	...
	<div class="row">
	  ...
	  <div class="col-md-5">
		<div style="height:120px;">
		  <canvas id="hrms_chart_projects"  style="display: block; height: 150px; width:300px;"></canvas>
		</div>
	  </div>
	</div>
  </div>
...
<div class="col-sm-4 col-xl-4">
  <div class="card mb-4">
	...
	<div class="row">
	  ...
	  <div class="col-md-5">
		<div style="height:120px;">
		  <canvas id="hrms_clients_leads" style="display: block; height: 150px; width:300px;"></canvas>
		</div>
	  </div>
	</div>
  </div>
...
<div class="col-md-4">
  <div class="card mb-4">
	...
	<div class="row">
	  ...
	  <div class="col-md-5">
		<div style="height:120px;">
		  <canvas id="hrms_tasks" style="display: block; height: 150px; width:300px;"></canvas>
		</div>
	  </div>
	</div>
  </div>
