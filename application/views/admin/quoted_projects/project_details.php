...
<div class="row animated fadeInRight">
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                <span class="stamp-hrms-4 stamp-hrms-md bg-hrms-secondary mr-3">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                <span class="stamp-hrms-4 stamp-hrms-md bg-hrms-danger-4 mr-3">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                <span class="stamp-hrms-4 stamp-hrms-md bg-hrms-warning-4 mr-3">
