...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('xin_hrms_custom_field_edit');?></h4>
</div>
...
<div class="modal-body">
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="form-group">
        ...
        <div class="hrms-custom-field-option"><?php echo $attribute;?></div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="form-group">
        <label for="email"><?php echo $this->lang->line('xin_hrms_field_label');?><i class="hrms-asterisk">*</i></label>
        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_hrms_field_label');?>" name="attribute_label" type="text" value="<?php echo $attribute_label;?>">
      </div>
    </div>
    <div class="col-md-3">
      <div class="form-group">
  ...
  <div class="row">
    <div class="col-md-3">
      <div class="form-group">
        <label for="xin_faxn"><?php echo $this->lang->line('xin_hrms_field_validation');?><i class="hrms-asterisk">*</i></label>
    ...
    <div class="col-md-3">
      <div class="form-group">
        <label for="phone"><?php echo $this->lang->line('xin_hrms_field_types');?></label>
        <small>(Can't Update)</small><br />
        <div class="hrms-custom-field-option">
