...
class Warning extends MY_Controller {
    ...
    public function warning_list() {
		...
		if(in_array('227',$role_resources_ids)) { // delete
                    ...
                    $delete = '<span data-toggle="tooltip" data-placement="top" data-state="danger"" title="'.$this->lang->line('xin_delete').'"><button type="button" class="btn icon-btn btn-sm btn-outline-danger waves-effect waves-light delete" data-toggle="modal" data-target=".delete-modal" data-record-id="'. $r->warning_id . '">
