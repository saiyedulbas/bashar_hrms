...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active">
      <a href="<?php echo site_url('admin/assets/');?>" data-link-data="<?php echo site_url('admin/assets/');?>" class="mb-3 nav-link hrms-link">
    ...
    <li class="nav-item done">
      <a href="<?php echo site_url('admin/assets/category/');?>" data-link-data="<?php echo site_url('admin/assets/category/');?>" class="mb-3 nav-link hrms-link">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="asset_value"><?php echo $this->lang->line('xin_company_asset_value');?></label>
                            <input class="form-control" placeholder="<?php echo $this->lang->line('xin_company_asset_value');?>" name="asset_value" type="text" value="">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
            ...
            <table class="datatables-demo table table-striped table-bordered" id="xin_table">
              <thead>
                <tr>
                  ...
                  <th><?php echo $this->lang->line('xin_company_asset_value');?></th>
