...
<ul class="sidenav-inner py-1">
  ...
  <li class="<?php if(!empty($arr_mod['hr_acc_open']))echo $arr_mod['hr_acc_open'];?> sidenav-item"> <a href="#" class="sidenav-link sidenav-toggle"> <i class="sidenav-icon ion ion-md-cash"></i>
    ...
    <ul class="sidenav-menu">
      ...
      <li class="sidenav-item <?php if(!empty($arr_mod['tax_chalan_active']))echo $arr_mod['tax_chalan_active'];?>"> <a class="sidenav-link" href="<?php echo site_url('admin/accounting/tax_chalan/');?>" > <?php echo $this->lang->line('xin_tax_chalan');?> </a> </li>
      <?php } ?>
    </ul>
  </li>
  <?php } ?>
  ...
  <li class="<?php if(!empty($arr_mod['pusher_open']))echo $arr_mod['pusher_open'];?> sidenav-item"> <a href="#" class="sidenav-link sidenav-toggle"> <i class="sidenav-icon fas fa-child"></i>
    <div><?php echo $this->lang->line('xin_support');?></div>
    </a>
    <ul class="sidenav-menu">
      <?php if(in_array('47',$role_resources_ids)) { ?>
      <li class="sidenav-item <?php if(!empty($arr_mod['faq_active']))echo $arr_mod['faq_active'];?>"> <a class="sidenav-link" href="<?php echo site_url('admin/chat/faq');?>" target="_blank"> <?php echo $this->lang->line('xin_faq');?> </a> </li>
	  <?php 
      if( $session['user_id'] == 201 || $session['user_id'] == 153 || $session['user_id'] == 531 || $session['user_id'] == 532 || $session['user_id'] == 1 || $session['user_id'] == 536){?>
		  <li class="sidenav-item <?php if(!empty($arr_mod['pusher_active']))echo $arr_mod['pusher_active'];?>"> <a class="sidenav-link" href="<?php echo site_url('admin/chat/newpusher/');?>" > <?php echo $this->lang->line('xin_support');?> </a> </li>
	  <?php }?>
  ...
  <?php if($system[0]->module_inquiry=='true'){?>
     ...
     <li class="sidenav-item"><a href="<?php echo site_url('admin/trainers')?>" class="sidenav-link"> <i class="fas fa-portrait sidenav-icon"></i><div><?php echo $this->lang->line('left_trainers_list');?></div></a></li>
      ...
      <li class="sidenav-item"><a class="sidenav-link" href="<?php echo site_url('admin/custom_fields');?>"> <i class="fas fa-sliders-h sidenav-icon"></i><div><?php echo $this->lang->line('xin_hrms_custom_fields');?></div></a></li>
      <?php } ?>
      <?php endif;?>
