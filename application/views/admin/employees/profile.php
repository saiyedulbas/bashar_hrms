                      ...
                      <div class="box">
                        <div class="box-body">
                          <div class="card-block">
                            ...
                            <div class="form-actions box-footer"> <?php echo form_button(array('name' => 'hrms_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="far fa-check-square"></i> '.$this->lang->line('xin_save'))); ?> </div>
                          </div>
                        </div>
                      </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
              <div class="row">
                <div class="col-md-3">
                   <div class="form-group">
                      <input type="hidden" name="emp_id" id="emp_id" value="<?php echo $user[0]->user_id;?>">
                  ...
                  <div class="col-md-2">
                      <div class="form-actions" style="margin-top:9%">
                          <button id="salary_statement" type="button" class="btn btn-primary"> <i class="fa fa-search"></i> <?php echo $this->lang->line('xin_save'); ?> </button>
                    </div>
                  </div>
