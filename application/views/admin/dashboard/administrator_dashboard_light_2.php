        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h5><span><?php echo $this->lang->line('xin_hrms_absent_today');?></span></h5>
                ...
                <div class="d-flex justify-content-between mt-2">
                    <p class="text-muted mb-0"><?php echo $this->lang->line('xin_hrms_absent_status');?></p>
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h5><span><?php echo $this->lang->line('xin_hrms_present_today');?></span></h5>
                ...
                <div class="d-flex justify-content-between mt-2">
                    <p class="text-muted mb-0"><?php echo $this->lang->line('xin_hrms_present_status');?></p>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <p class="text-muted"><?php echo $this->lang->line('xin_hrms_project_status');?></p>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <p class="text-muted"><?php echo $this->lang->line('xin_hrms_task_status');?></p>
                    </div>
