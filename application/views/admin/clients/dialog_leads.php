...
<div class="modal-footer">
  ...
  <?php $hidden = array('_method' => 'DELETE', '_token_del_file' => 'hrms', 'token_type' => 'hrms');?>
  <?php echo form_open(site_url('admin/leads/change_to_client/'.$client_id), $attributes, $hidden);?> <?php echo form_button(array('data-dismiss' => 'modal', 'type' => 'button', 'class' => 'btn btn-secondary', 'content' => '<i class="fas fa-check-square"></i> '.$this->lang->line('xin_close'))); ?> <?php echo form_button(array('name' => 'hrms_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fas fa-check-square"></i> '.$this->lang->line('xin_lead_confirm_change_btn'))); ?> <?php echo form_close(); ?> </div>
<?php echo form_close(); ?> 
<script type="text/javascript">
$(document).ready(function(){
	Ladda.bind('button[type=submit]');
